...
import { defineComponent, inject, ref, computed, getCurrentInstance, toRaw, watch, onMounted, onBeforeUnmount, provide, reactive, readonly, openBlock, createElementBlock, createElementVNode, normalizeClass, Fragment, renderList, withDirectives, toDisplayString, vShow, createCommentVNode, vModelText, resolveComponent, createVNode, createBlock, unref, withCtx, useSSRContext, mergeProps, isRef, resolveDynamicComponent, createTextVNode } from 'vue';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderVNode, ssrRenderStyle } from 'vue/server-renderer';
import { _ as _sfc_main$a } from './Avatar-ppAiHF0k.mjs';
import { _ as __nuxt_component_0 } from './LoadingDiv-CLaVNDei.mjs';
import { e as useLoadingStore, h as useLessonsStore, x as useLikesStore, u as useRouter, j as useCoursesStore, w as useCommentsStore } from './server.mjs';
import { f as formatDate } from './format-D41WL6ul.mjs';
import { _ as _imports_0$4, a as _sfc_main$b } from './star-XO2JF98c.mjs';
import { _ as _imports_0$3 } from './a_star-Cwe52rgh.mjs';
import { _ as _imports_3$1, a as _imports_2$2, b as _imports_3$1$1, c as _imports_4$1, d as _imports_5$1 } from './markasread-Bigmtseo.mjs';
import { _ as _sfc_main$8 } from './Modal-CNknc8lN.mjs';
import { _ as _imports_0$2, a as _sfc_main$9 } from './back_route-DYkfboeQ.mjs';
import { _ as _imports_4 } from './statistics-MmNdhvZG.mjs';
...
var Body = /* @__PURE__ */ _export_sfc(_sfc_main$4$1, [["render", _sfc_render$4]]);
...
var Header = /* @__PURE__ */ _export_sfc(_sfc_main$3$1, [["render", _sfc_render$3]]);
...
var Footer = /* @__PURE__ */ _export_sfc(_sfc_main$2$1, [["render", _sfc_render$2]]);
...
var PickerRoot = /* @__PURE__ */ _export_sfc(_sfc_main$1$1, [["render", _sfc_render$1]]);
...
var Picker = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render]]);
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_EditorTiptapEditor, {
        modelValue: __props.lesson_lecture,
        editable: false
      }, null, _parent));
      _push(`</div>`);
    };
...
_sfc_main$6.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Page/Lesson/Lectures.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const _imports_0$1 = "data:image/svg+xml,%3csvg%20width='20'%20height='18'%20viewBox='0%200%2020%2018'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M16.3545%202.25H3.82967C3.39913%202.25%203.04688%202.5875%203.04688%203V15C3.04688%2015.4125%203.39913%2015.75%203.82967%2015.75H16.3545C16.785%2015.75%2017.1373%2015.4125%2017.1373%2015V3C17.1373%202.5875%2016.785%202.25%2016.3545%202.25ZM7.74367%205.25H6.17807V6.75H7.74367V5.25ZM13.2233%206.75H10.0921C9.66153%206.75%209.30927%206.4125%209.30927%206C9.30927%205.5875%209.66153%205.25%2010.0921%205.25H13.2233C13.6538%205.25%2014.0061%205.5875%2014.0061%206C14.0061%206.4125%2013.6538%206.75%2013.2233%206.75ZM13.2233%209.75H10.0921C9.66153%209.75%209.30927%209.4125%209.30927%209C9.30927%208.5875%209.66153%208.25%2010.0921%208.25H13.2233C13.6538%208.25%2014.0061%208.5875%2014.0061%209C14.0061%209.4125%2013.6538%209.75%2013.2233%209.75ZM10.0921%2012.75H13.2233C13.6538%2012.75%2014.0061%2012.4125%2014.0061%2012C14.0061%2011.5875%2013.6538%2011.25%2013.2233%2011.25H10.0921C9.66153%2011.25%209.30927%2011.5875%209.30927%2012C9.30927%2012.4125%209.66153%2012.75%2010.0921%2012.75ZM6.17807%208.25H7.74367V9.75H6.17807V8.25ZM7.74367%2011.25H6.17807V12.75H7.74367V11.25ZM4.61247%2014.25H15.5717V3.75H4.61247V14.25Z'%20fill='white'/%3e%3c/svg%3e";
const _imports_1$1 = "data:image/svg+xml,%3csvg%20width='20'%20height='18'%20viewBox='0%200%2020%2018'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M17.1364%202.625H3.04607C2.18499%202.625%201.48047%203.3%201.48047%204.125V13.875C1.48047%2014.7%202.18499%2015.375%203.04607%2015.375H17.1364C17.9975%2015.375%2018.702%2014.7%2018.702%2013.875V4.125C18.702%203.3%2017.9975%202.625%2017.1364%202.625ZM17.1364%2013.125C17.1364%2013.5375%2016.7842%2013.875%2016.3536%2013.875H10.0913V4.125H16.3536C16.7842%204.125%2017.1364%204.4625%2017.1364%204.875V13.125ZM11.4612%206.75H15.7665C16.0875%206.75%2016.3536%207.005%2016.3536%207.3125C16.3536%207.62%2016.0875%207.875%2015.7665%207.875H11.4612C11.1402%207.875%2010.8741%207.62%2010.8741%207.3125C10.8741%207.005%2011.1402%206.75%2011.4612%206.75ZM15.7665%208.625H11.4612C11.1402%208.625%2010.8741%208.88%2010.8741%209.1875C10.8741%209.495%2011.1402%209.75%2011.4612%209.75H15.7665C16.0875%209.75%2016.3536%209.495%2016.3536%209.1875C16.3536%208.88%2016.0875%208.625%2015.7665%208.625ZM11.4612%2010.5H15.7665C16.0875%2010.5%2016.3536%2010.755%2016.3536%2011.0625C16.3536%2011.37%2016.0875%2011.625%2015.7665%2011.625H11.4612C11.1402%2011.625%2010.8741%2011.37%2010.8741%2011.0625C10.8741%2010.755%2011.1402%2010.5%2011.4612%2010.5Z'%20fill='white'/%3e%3c/svg%3e";
const _imports_2$1 = "data:image/svg+xml,%3csvg%20width='20'%20height='18'%20viewBox='0%200%2020%2018'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M17.1364%204.42422H11.195L13.4964%202.21922C13.653%202.06922%2013.653%201.83672%2013.4964%201.68672C13.3399%201.53672%2013.0972%201.53672%2012.9406%201.68672L10.0913%204.41672L7.24187%201.68672C7.08531%201.53672%206.84264%201.53672%206.68608%201.68672C6.52952%201.83672%206.52952%202.06922%206.68608%202.21922L8.98751%204.42422H3.04607C2.18499%204.42422%201.48047%205.09172%201.48047%205.92422V14.9242C1.48047%2015.7492%202.18499%2016.4242%203.04607%2016.4242H17.1364C17.9975%2016.4242%2018.702%2015.7492%2018.702%2014.9242V5.92422C18.702%205.09172%2017.9975%204.42422%2017.1364%204.42422ZM8.91706%2012.7867L12.0326%2011.0767C12.5571%2010.7917%2012.5571%2010.0642%2012.0326%209.77172L8.91706%208.06172C8.39258%207.77672%207.74286%208.14422%207.74286%208.71422V12.1267C7.74286%2012.7042%208.39258%2013.0717%208.91706%2012.7867ZM3.82887%2014.9242H16.3536C16.7842%2014.9242%2017.1364%2014.5867%2017.1364%2014.1742V6.67422C17.1364%206.26172%2016.7842%205.92422%2016.3536%205.92422H3.82887C3.39833%205.92422%203.04607%206.26172%203.04607%206.67422V14.1742C3.04607%2014.5867%203.39833%2014.9242%203.82887%2014.9242Z'%20fill='white'/%3e%3c/svg%3e";
const _imports_3 = "data:image/svg+xml,%3csvg%20width='20'%20height='18'%20viewBox='0%200%2020%2018'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M11.6577%203.48952V3.33952C11.6577%202.86702%2012.1508%202.52952%2012.6048%202.70202C15.2585%203.66952%2017.1373%206.12202%2017.1373%209.00202C17.1373%2011.882%2015.2585%2014.3345%2012.6048%2015.302C12.1508%2015.467%2011.6577%2015.137%2011.6577%2014.6645V14.5145C11.6577%2014.2295%2011.8455%2013.982%2012.1273%2013.877C14.147%2013.1045%2015.5717%2011.207%2015.5717%209.00202C15.5717%206.79702%2014.147%204.89952%2012.1273%204.12702C11.8534%204.02202%2011.6577%203.77452%2011.6577%203.48952ZM3.04688%207.50202V10.502C3.04688%2010.9145%203.39913%2011.252%203.82967%2011.252H6.17807L8.75348%2013.7195C9.24664%2014.192%2010.0921%2013.8545%2010.0921%2013.187V4.80952C10.0921%204.14202%209.24664%203.80452%208.75348%204.27702L6.17807%206.75202H3.82967C3.39913%206.75202%203.04688%207.08952%203.04688%207.50202ZM13.6147%209.00202C13.6147%207.67452%2012.8162%206.53452%2011.6577%205.97952V12.017C12.8162%2011.4695%2013.6147%2010.3295%2013.6147%209.00202Z'%20fill='white'/%3e%3c/svg%3e";
const _sfc_main$5 = {
  __name: "Overview",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      var _a, _b, _c, _d;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-4" }, _attrs))}><nav class="r_8 bg_main p-4"><ul class="text-sm text-white space-y-3"><li class="flex items-center gap-3"><img loading="lazy"${ssrRenderAttr("src", _imports_0$1)} alt=""><span>${ssrInterpolate((_a = __props.lesson_course) == null ? void 0 : _a.lesson_count)} Lesson</span></li><li class="flex items-center gap-3"><img loading="lazy"${ssrRenderAttr("src", _imports_1$1)} alt=""><span>${ssrInterpolate((_b = __props.lesson_course) == null ? void 0 : _b.lecture_count)} Lectures</span></li><li class="flex items-center gap-3"><img loading="lazy"${ssrRenderAttr("src", _imports_2$1)} alt=""><span>${ssrInterpolate((_c = __props.lesson_course) == null ? void 0 : _c.total_duration)}s total lenghts</span></li><li class="flex items-center gap-3"><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt=""><span>English</span></li></ul></nav><section><p>${(_a2 = (_d = __props.lesson_course) == null ? void 0 : _d.description) != null ? _a2 : ""}</p></section></div>`);
    };
  }
};
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Page/Lesson/Overview.vue");
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d, _e;
      const _component_UIAvatar = _sfc_main$a;
      const _component_LoadingDiv = __nuxt_component_0;
      _push(`<main${ssrRenderAttrs(_attrs)}><ul class="space-y-4"><!--[-->`);
      ssrRenderList((_a = __props.comments) == null ? void 0 : _a.records, (i) => {
        var _a3;
        var _a2, _b2, _c2;
        ...
        _push(`<div class="space-y-0.5"><h1>${ssrInterpolate((_b2 = i.user) == null ? void 0 : _b2.name)} ${ssrInterpolate((_c2 = i.user) == null ? void 0 : _c2.surname)}</h1><p class="text-xs">${ssrInterpolate(unref(formatDate)(i.createdAt))}</p><p class="opacity-60 max-w-[70%]">${(_a3 = i.comment) != null ? _a3 : ""}</p></div></li>`);
      });
      _push(`<!--]--></ul><div style="${ssrRenderStyle(((_c = (_b = __props.comments) == null ? void 0 : _b.pagination) == null ? void 0 : _c.currentPage) < ((_e = (_d = __props.comments) == null ? void 0 : _d.pagination) == null ? void 0 : _e.total_pages) ? null : { display: "none" })}" id="loadingDiv" class="grid gap-4 py-4"><!--[-->`);
      ssrRenderList(12, (i) => {
        _push(ssrRenderComponent(_component_LoadingDiv, { class: "w-full h-full min-h-[64px] r_12" }, null, _parent));
      });
      _push(`<!--]--></div></main>`);
    };
  }
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Page/Lesson/Comments.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const _sfc_main$3 = {
  __name: "SimilarCourses",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_VideoReader = _sfc_main$b;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      if (unref(isLoading).isLoadingType("lessons")) {
        ...
        ssrRenderList(unref(useLesson).store.all_lessons, (i) => {
          ...
          _push(ssrRenderComponent(_component_router_link, {
            to: `/lesson/${i.id}`,
            class: "flex justify-between max-h-fit p-2 hover:bg-[#E2E2E2] r_8"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<ul class="space-y-2 w-full max-w-[60%]"${_scopeId}><li class="text-lg font-semibold truncate"${_scopeId}>${ssrInterpolate(i.title)}</li><li class="flex gap-1"${_scopeId}><span${_scopeId}>${ssrInterpolate(i.likes_count)}</span><img loading="lazy"${ssrRenderAttr("src", _imports_0$3)} alt=""${_scopeId}></li><li${_scopeId}>10.5k Learners</li></ul><div class="full_flex max-w-[40%] r_12"${_scopeId}><div class="aspect-video w-full object-cover bg-black r_8"${_scopeId}>`);
                _push2(ssrRenderComponent(_component_ClientOnly, null, {}, _parent2, _scopeId));
                _push2(`</div></div>`);
              } else {
                return [
                  createVNode("ul", { class: "space-y-2 w-full max-w-[60%]" }, [
                    createVNode("li", { class: "text-lg font-semibold truncate" }, toDisplayString(i.title), 1),
                    createVNode("li", { class: "flex gap-1" }, [
                      createVNode("span", null, toDisplayString(i.likes_count), 1),
                      createVNode("img", {
                        loading: "lazy",
                        src: _imports_0$3,
                        alt: ""
                    ...
                    createVNode("li", null, "10.5k Learners")
                  ]),
                  createVNode("div", { class: "full_flex max-w-[40%] r_12" }, [
                    createVNode("div", { class: "aspect-video w-full object-cover bg-black r_8" }, [
        ...
        _push(`<div class="py-10 text-center"> Ma&#39;lumot topilmadi </div>`);
      }
      _push(`</div>`);
    };
  }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Page/Lesson/SimilarCourses.vue");
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Picker), mergeProps({
        native: true,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const PageLessonLectures = _sfc_main$6;
    const PageLessonOverview = _sfc_main$5;
    const PageLessonComments = _sfc_main$4;
    const PageLessonSimilarCourses = _sfc_main$3;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Emoji = _sfc_main$2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "pb-0 -mb-5" }, _attrs))}><nav class="tabnav"><div>`);
      _push(ssrRenderComponent(_component_a_tabs, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(unref(lesson_tabs), (i) => {
              _push2(ssrRenderComponent(_component_a_tab_pane, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(getComponent(i.component)), {
                      class: "min-h-[calc(100vh_-_256px)]",
                      lesson_lecture: __props.lesson_lecture,
                      comments: __props.comments,
                      lesson_course: __props.lesson_course
                    }, null), _parent3, _scopeId2);
                  } else {
                    return [
                      (openBlock(), createBlock(resolveDynamicComponent(getComponent(i.component)), {
                        class: "min-h-[calc(100vh_-_256px)]",
                        lesson_lecture: __props.lesson_lecture,
                        comments: __props.comments,
                        lesson_course: __props.lesson_course
                      }, null, 8, ["lesson_lecture", "comments", "lesson_course"]))
                    ];
                  }
                }),
                _: 2
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(unref(lesson_tabs), (i) => {
      ...
      _push(`</div></nav><footer class="${ssrRenderClass([unref(store).scrollY ? "bottom-0" : "-bottom-40", "boxtshadow bg-white py-4 duration-700 sticky -mx-5 px-4"])}"><ul>`);
      if (unref(activeKey) == 1) {
        _push(`<li>`);
        if (((_b = (_a = unref(useLessons).store.lessons) == null ? void 0 : _a.course) == null ? void 0 : _b.user_id) != ((_c = unref(isLoading).user) == null ? void 0 : _c.id)) {
          _push(`<div>`);
          if ((_e = (_d = unref(useLessons).store.lessons) == null ? void 0 : _d.course) == null ? void 0 : _e.test_count) {
            _push(ssrRenderComponent(_component_router_link, {
              to: `/test/${_ctx.$router.currentRoute.value.params.lesson_id}`,
              class: "full_flex bg-white"
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<button class="bg_main px-5 py-2 r_8 w-full text-white"${_scopeId}>Testni boshlash</button>`);
                } else {
                  return [
                    createVNode("button", { class: "bg_main px-5 py-2 r_8 w-full text-white" }, "Testni boshlash")
                  ];
                }
              }),
              _: 1
            ...
            _push(`<div class="full_flex bg-white"><button class="bg_main px-5 py-2 r_8 w-full text-white">Test mavjud emas</button></div>`);
          }
          _push(`</div>`);
        } else if (((_g = (_f = unref(useLessons).store.lessons) == null ? void 0 : _f.course) == null ? void 0 : _g.user_id) == ((_h = unref(isLoading).user) == null ? void 0 : _h.id)) {
          _push(`<div>`);
          _push(ssrRenderComponent(_component_router_link, {
            to: `/test/${_ctx.$router.currentRoute.value.params.lesson_id}`,
            class: "full_flex bg-white"
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button class="bg_main px-5 py-2 r_8 w-full text-white"${_scopeId}>Test qo&#39;shish</button>`);
              } else {
                return [
                  createVNode("button", { class: "bg_main px-5 py-2 r_8 w-full text-white" }, "Test qo'shish")
                ];
              }
            }),
            _: 1
        ...
        _push(`<li class="flex gap-4">`);
        _push(ssrRenderComponent(_component_a_button, {
          loading: unref(isLoading).isLoadingType("like"),
          onClick: ($event) => unref(useLikes).postLike(+_ctx.$route.params.lesson_id),
          class: ["full_flex gap-2 px-5 py-2 min-h-fit r_8 w-full truncate", ((_i = unref(useLessons).store.lessons) == null ? void 0 : _i.is_liked) ? "bg_main c_white" : "b_main c_main"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2;
            if (_push2) {
              if ((_a2 = unref(useLessons).store.lessons) == null ? void 0 : _a2.is_liked) {
                _push2(`<img loading="lazy"${ssrRenderAttr("src", _imports_0)} alt=""${_scopeId}>`);
              } else {
                _push2(`<img loading="lazy"${ssrRenderAttr("src", _imports_0$4)} alt=""${_scopeId}>`);
              }
              _push2(`<span class="max-w-full truncate"${_scopeId}>Like</span>`);
            } else {
              return [
                ((_b2 = unref(useLessons).store.lessons) == null ? void 0 : _b2.is_liked) ? (openBlock(), createBlock("img", {
                  key: 0,
                  loading: "lazy",
                  src: _imports_0,
                  alt: ""
                ...
                createVNode("span", { class: "max-w-full truncate" }, "Like")
              ];
            }
          }),
          _: 1
        ...
        _push(ssrRenderComponent(_component_a_button, {
          ...
          onClick: ($event) => {
            var _a2;
            return unref(useCourses).subscribeCourse((_a2 = __props.lesson_course) == null ? void 0 : _a2.id);
          },
          class: ["px-5 py-2 r_8 w-full min-h-fit truncate", ((_k = (_j = unref(useLessons).store.lessons) == null ? void 0 : _j.course) == null ? void 0 : _k.is_subscribed) ? "bg_main c_white" : "b_main c_main"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2;
            if (_push2) {
              _push2(`${ssrInterpolate(((_a2 = __props.lesson_course) == null ? void 0 : _a2.is_subscribed) ? "Subscribed" : "Subscribe")}`);
            } else {
              return [
                createTextVNode(toDisplayString(((_b2 = __props.lesson_course) == null ? void 0 : _b2.is_subscribed) ? "Subscribed" : "Subscribe"), 1)
              ];
            }
          }),
          _: 1
        ...
        _push(`<li class="flex items-end justify-between gap-4"><img loading="lazy"${ssrRenderAttr("src", _imports_2$2)} alt="">`);
        _push(ssrRenderComponent(_component_EditorTiptapEditor, {
          class: "w-[80%] -ml-4 -mb-2",
          modelValue: unref(useComments).store.comment.text,
          "onUpdate:modelValue": ($event) => unref(useComments).store.comment.text = $event,
          toolbar: false,
        ...
        _push(ssrRenderComponent(_component_a_dropdown, {
          ...
          overlay: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_a_menu, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_Emoji, null, null, _parent3, _scopeId2));
                  } else {
                    return [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="pcursor"${_scopeId}><img loading="lazy"${ssrRenderAttr("src", _imports_3$1$1)} alt=""${_scopeId}></div>`);
            } else {
              return [
                createVNode("div", { class: "pcursor" }, [
                  createVNode("img", {
                    loading: "lazy",
                    src: _imports_3$1$1,
                    alt: ""
        ...
        _push(`<img loading="lazy"${ssrRenderAttr("src", _imports_4$1)} alt=""><img loading="lazy"${ssrRenderAttr("src", _imports_5$1)} alt=""></li>`);
        ...
        _push(ssrRenderComponent(_component_router_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="bg_main px-5 py-2 r_8 w-full text-white"${_scopeId}>Shu kursga tegishli darslar</button>`);
            } else {
              return [
                createVNode("button", { class: "bg_main px-5 py-2 r_8 w-full text-white" }, "Shu kursga tegishli darslar")
              ];
            }
          }),
          _: 1
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Page/Lesson/Tabs.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const _imports_1 = "data:image/svg+xml,%3csvg%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M4%2012V20C4%2020.5304%204.21071%2021.0391%204.58579%2021.4142C4.96086%2021.7893%205.46957%2022%206%2022H18C18.5304%2022%2019.0391%2021.7893%2019.4142%2021.4142C19.7893%2021.0391%2020%2020.5304%2020%2020V12'%20stroke='black'%20stroke-width='1.7'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M16%206L12%202L8%206'%20stroke='black'%20stroke-width='1.7'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M12%202V15'%20stroke='black'%20stroke-width='1.7'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e";
const _imports_2 = "data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M5.33398%208.66667L8.15265%2010.9213C8.28973%2011.0308%208.46445%2011.0819%208.63891%2011.0634C8.81338%2011.0449%208.97354%2010.9584%209.08465%2010.8227L14.6673%204'%20stroke='%23FFFFFF'%20stroke-width='1.33333'%20stroke-linecap='round'/%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M7.46033%208.15807L10.5163%204.42207C10.6251%204.28489%2010.6755%204.11045%2010.6567%203.93642C10.6379%203.76239%2010.5514%203.60273%2010.4159%203.49192C10.2804%203.3811%2010.1068%203.32802%209.93247%203.34414C9.75817%203.36026%209.59721%203.44428%209.48433%203.57807L6.43566%207.30473L7.46033%208.15807ZM5.34899%2010.7381L4.32433%209.88473L3.88899%2010.4167L1.73366%208.80007C1.59221%208.69398%201.41441%208.64843%201.23938%208.67343C1.06435%208.69844%200.906415%208.79195%200.800328%208.9334C0.694242%209.07485%200.64869%209.25265%200.673695%209.42768C0.6987%209.60271%200.792213%209.76065%200.933662%209.86673L3.08899%2011.4834C3.36414%2011.6897%203.70836%2011.7817%204.04974%2011.7402C4.39113%2011.6987%204.70328%2011.5269%204.92099%2011.2607L5.34899%2010.7381Z'%20fill='%23FFFFFF'/%3e%3c/svg%3e";
const _imports_5 = "data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M14.2357%201.76394C13.9923%201.52051%2013.7033%201.3274%2013.3853%201.19565C13.0673%201.0639%2012.7264%200.996094%2012.3822%200.996094C12.0379%200.996094%2011.6971%201.0639%2011.379%201.19565C11.061%201.3274%2010.772%201.52051%2010.5287%201.76394L2.65665%209.63594C2.28278%2010.0101%202.01618%2010.4777%201.88465%2010.9899L1.01465%2014.3759C0.993079%2014.4602%200.993851%2014.5486%201.01689%2014.6325C1.03994%2014.7163%201.08446%2014.7927%201.14605%2014.8541C1.20765%2014.9155%201.28419%2014.9598%201.36812%2014.9825C1.45206%2015.0053%201.54048%2015.0058%201.62465%2014.9839L5.00965%2014.1149C5.52204%2013.9836%205.98969%2013.717%206.36365%2013.3429L14.2357%205.47094C14.4791%205.22755%2014.6722%204.93859%2014.8039%204.62057C14.9357%204.30254%2015.0035%203.96168%2015.0035%203.61744C15.0035%203.2732%2014.9357%202.93234%2014.8039%202.61431C14.6722%202.29629%2014.4791%202.00733%2014.2357%201.76394ZM11.2357%202.47094C11.5397%202.16687%2011.9521%201.99604%2012.3822%201.99604C12.8122%201.99604%2013.2246%202.16687%2013.5287%202.47094C13.8327%202.77501%2014.0035%203.18742%2014.0035%203.61744C14.0035%204.04746%2013.8327%204.45987%2013.5287%204.76394L12.7497%205.54294L10.4567%203.24994L11.2357%202.47094ZM9.74965%203.95694L12.0427%206.24994L5.65665%2012.6359C5.40903%2012.8831%205.09959%2013.0592%204.76065%2013.1459L2.19365%2013.8059L2.85365%2011.2389C2.93973%2010.8997%203.11595%2010.5901%203.36365%2010.3429L9.74965%203.95694Z'%20fill='%23FF852E'/%3e%3c/svg%3e";
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ClientOnly = __nuxt_component_1;
      const _component_a_button = resolveComponent("a-button");
      const _component_PageLessonTabs = _sfc_main$1;
      const _component_UIModal = _sfc_main$8;
      const _component_PageGroupReytingMain = _sfc_main$9;
      _push(`<div${ssrRenderAttrs(_attrs)}><div><div id="youtube-player"></div>`);
      if (unref(videoEnded)) {
        _push(`<p>Video tugadi!</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><nav class="sticky top-[140px]"><nav><ul class="flex items-center justify-between border-b border-[#EDEDED] pb-4"><li class="full_flex gap-4 pcursor"><img loading="lazy"${ssrRenderAttr("src", _imports_0$2)} alt=""><span class="text-lg font-semibold c_c92">Orqaga</span></li><li><img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt=""></li></ul></nav><section class="px-[0.5px] pt-5 md:mb-0 mb-5">`);
      if ((_a = unref(useLessons).store.lessons) == null ? void 0 : _a.video) {
        _push(`<div class="w-full md:h-[312px] h-[200px] r_8 rounded-lg overflow-hidden mb-5">`);
        _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex items-center justify-between mb-5"><h1 class="text-xl font-semibold">${ssrInterpolate((_b = unref(useLessons).store.lessons) == null ? void 0 : _b.title)}</h1><div class="flex items-center gap-5 space-x-3">`);
      if (((_d = (_c = unref(useLessons).store.lessons) == null ? void 0 : _c.course) == null ? void 0 : _d.user_id) != ((_e = unref(isLoading).user) == null ? void 0 : _e.id)) {
        _push(`<button class="${ssrRenderClass([((_g = (_f = unref(useLessons).store.lessons) == null ? void 0 : _f.course) == null ? void 0 : _g.is_finished) ? "bg_main" : "bg_white", "b_main p-3 r_8"])}">`);
        if ((_i = (_h = unref(useLessons).store.lessons) == null ? void 0 : _h.course) == null ? void 0 : _i.is_finished) {
          _push(`<img loading="lazy" class="stroke-[#FF852E]"${ssrRenderAttr("src", _imports_2)} alt="">`);
        } else {
          _push(`<img loading="lazy" class="stroke-[#FF852E]"${ssrRenderAttr("src", _imports_3$1)} alt="">`);
        }
        _push(`</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<img class="h-[42px] pcursor" loading="lazy"${ssrRenderAttr("src", _imports_4)} alt="">`);
      if (((_k = (_j = unref(useLessons).store.lessons) == null ? void 0 : _j.course) == null ? void 0 : _k.user_id) == ((_l = unref(isLoading).user) == null ? void 0 : _l.id)) {
        _push(`<button class="b_main p-3 r_8"><img loading="lazy"${ssrRenderAttr("src", _imports_5)} alt=""></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><ul class="flex items-center justify-between"><li class="flex items-center gap-2"><img loading="lazy" class="object-cover r_f w-10 h-10"${ssrRenderAttr("src", (_n = (_m = unref(useLessons).store.lessons) == null ? void 0 : _m.course) == null ? void 0 : _n.cover)} alt=""><ul><li class="text-sm font-bold">${ssrInterpolate((_p = (_o = unref(useLessons).store.lessons) == null ? void 0 : _o.course) == null ? void 0 : _p.title)}</li><li class="text-xs">${ssrInterpolate((_r = (_q = unref(useLessons).store.lessons) == null ? void 0 : _q.course) == null ? void 0 : _r.subscriptions_count)} subscribers </li></ul></li><li class="flex gap-2">`);
      _push(ssrRenderComponent(_component_a_button, {
        loading: unref(isLoading).isLoadingType("like"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if ((_a2 = unref(useLessons).store.lessons) == null ? void 0 : _a2.is_liked) {
              _push2(`<img class="w-5 h-5" loading="lazy"${ssrRenderAttr("src", _imports_0$3)} alt=""${_scopeId}>`);
            } else {
              _push2(`<img class="w-5 h-5" loading="lazy"${ssrRenderAttr("src", _imports_0$4)} alt=""${_scopeId}>`);
            }
            _push2(`<span${_scopeId}>${ssrInterpolate((_c2 = (_b2 = unref(useLessons).store.lessons) == null ? void 0 : _b2.course) == null ? void 0 : _c2.likes_count)}</span>`);
          } else {
            return [
              ((_d2 = unref(useLessons).store.lessons) == null ? void 0 : _d2.is_liked) ? (openBlock(), createBlock("img", {
                key: 0,
                class: "w-5 h-5",
                loading: "lazy",
                src: _imports_0$3,
              ...
              createVNode("span", null, toDisplayString((_f2 = (_e2 = unref(useLessons).store.lessons) == null ? void 0 : _e2.course) == null ? void 0 : _f2.likes_count), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li></ul></section></nav><section class="bg-white z-10 relative" id="tabs">`);
      _push(ssrRenderComponent(_component_PageLessonTabs, {
        class: "lesson_tab",
        lesson_lecture: (_s = unref(useLessons).store.lessons) == null ? void 0 : _s.content,
        comments: (_t = unref(useLessons).store.lessons) == null ? void 0 : _t.comments,
        lesson_course: (_u = unref(useLessons).store.lessons) == null ? void 0 : _u.course
      }, null, _parent));
      _push(`</section>`);
      _push(ssrRenderComponent(_component_UIModal, {
        ...
        "onUpdate:isOpen": (value) => unref(isLoading).modal.create = false
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(isLoading).modal.create) {
              _push2(ssrRenderComponent(_component_PageGroupReytingMain, {
                type: "lesson",
                lesson_id: _ctx.$route.params.lesson_id
            ...
            return [
              unref(isLoading).modal.create ? (openBlock(), createBlock(_component_PageGroupReytingMain, {
                key: 0,
                type: "lesson",
                lesson_id: _ctx.$route.params.lesson_id
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/lesson/[lesson_id]/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-B_R9w9lQ.mjs.map
