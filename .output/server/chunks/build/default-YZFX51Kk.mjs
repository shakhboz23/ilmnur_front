...
import { _ as _imports_1$1 } from './virtual_public-k04r-7F-.mjs';
import { e as useLoadingStore, u as useRouter, _ as _export_sfc, f as useCategoryStore } from './server.mjs';
import { _ as _imports_0$2, a as _sfc_main$5 } from './back_route-D4cHSbpK.mjs';
import { _ as _sfc_main$6 } from './Modal-CNknc8lN.mjs';
...
const _shorts = "" + buildAssetsURL("shorts.t5uLzeVu.svg");
const _subscription = "data:image/svg+xml,%3csvg%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M0%2024V7.57945H24V24H0ZM1.33333%2022.6316H22.6667V8.94783H1.33333V22.6316ZM10%2020.0002L16.1547%2015.7897L10%2011.5792V20.0002ZM2%205.15879V3.79041H22V5.15879H2ZM6%201.36838V0H18V1.36838H6Z'%20fill='%23242424'/%3e%3c/svg%3e";
const _history = "data:image/svg+xml,%3csvg%20width='26'%20height='26'%20viewBox='0%200%2026%2026'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M18.3387%202.42687C12.759%20-0.418128%205.94527%201.13494%202.26303%205.80834V2.8099C2.26303%202.4787%201.98027%202.21017%201.63151%202.21017C1.28276%202.21017%201%202.4787%201%202.8099V7.60849C1.00023%207.93947%201.28292%208.20771%201.63151%208.20749H6.68363C7.03238%208.20749%207.31515%207.93896%207.31515%207.60776C7.31515%207.27656%207.03238%207.00803%206.68363%207.00803H2.92415C5.01689%204.0418%208.52475%202.2158%2012.332%202.21017C18.61%202.20094%2023.7072%207.02662%2023.7169%2012.9887C23.7267%2018.9506%2018.6453%2023.7913%2012.3673%2023.8005C12.0185%2023.8005%2011.7357%2024.0691%2011.7357%2024.4003C11.7357%2024.7315%2012.0185%2025%2012.3673%2025C17.0193%2024.9979%2021.2939%2022.5686%2023.4944%2018.6762C26.7956%2012.837%2024.4873%205.56192%2018.3387%202.42687ZM12.3673%208.20749C12.0185%208.20749%2011.7357%208.47603%2011.7357%208.80722V13.006C11.736%2013.3371%2012.0187%2013.6053%2012.3673%2013.6051H15.5248C15.8736%2013.6051%2016.1564%2013.3366%2016.1564%2013.0054C16.1564%2012.6742%2015.8736%2012.4056%2015.5248%2012.4056H12.9988V8.80722C12.9988%208.47603%2012.716%208.20749%2012.3673%208.20749Z'%20fill='%23242424'%20stroke='%23242424'%20stroke-width='0.5'/%3e%3c/svg%3e";
const _group = "" + buildAssetsURL("group.DdH-4fOd.svg");
const _settings = "" + buildAssetsURL("settings.7mz_uNFG.svg");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen min-w-screen full_flex" }, _attrs))}><img loading="lazy"${ssrRenderAttr("src", _imports_1$1)} alt=""></div>`);
}
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_router_link, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img loading="lazy" class="min-w-fit"${ssrRenderAttr("src", _imports_1$1)} alt=""${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                loading: "lazy",
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "min-w-[260px] h-[calc(100vh_-_140px)] overflow-y-auto noscroll md:p-4 bg-white r_8" }, _attrs))} data-v-85ecf7dc><ul class="space-y-7" data-v-85ecf7dc>`);
      if (unref(store).is_sidebar) {
        _push(ssrRenderComponent(_component_router_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img loading="lazy" class="pcursor"${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-85ecf7dc${_scopeId}><span data-v-85ecf7dc${_scopeId}>Orqaga</span>`);
            } else {
              return [
                createVNode("img", {
                  loading: "lazy",
      ...
      if (unref(isLoading).store.isLogin && !unref(store).is_sidebar) {
        _push(`<li class="flex items-center gap-1 w-full" data-v-85ecf7dc><div class="relative min-w-fit" data-v-85ecf7dc><div class="clip" data-v-85ecf7dc><div class="min-h-[53px] min-w-[53px] max-h-[53px] max-w-[53px]" data-v-85ecf7dc>`);
        ...
        _push(`</div></div><img loading="lazy" class="absolute rotate-[180deg] -bottom-1 -right-[1px]"${ssrRenderAttr("src", _imports_1)} alt="" data-v-85ecf7dc></div><ul class="max-w-[60%]" data-v-85ecf7dc><li class="font-bold whitespace-nowrap truncate" data-v-85ecf7dc><h1 class="truncate" data-v-85ecf7dc>${ssrInterpolate((_b = unref(isLoading).user) == null ? void 0 : _b.name)} ${ssrInterpolate((_c = unref(isLoading).user) == null ? void 0 : _c.surname)}</h1></li><li class="flex gap-1 pcursor font-medium text-sm c_c66" data-v-85ecf7dc><span data-v-85ecf7dc>id: ${ssrInterpolate((_d = unref(isLoading).user) == null ? void 0 : _d.id)}</span><img loading="lazy"${ssrRenderAttr("src", _imports_2)} alt="" data-v-85ecf7dc></li></ul><img loading="lazy" class=""${ssrRenderAttr("src", _imports_3$1)} alt="" data-v-85ecf7dc></li>`);
      } else {
        _push(`<!---->`);
      }
      if (_ctx.$router.currentRoute.value.path.includes("my_groups")) {
        _push(`<li data-v-85ecf7dc><!--[-->`);
        ssrRenderList(unref(group_sidebar), (i) => {
          _push(ssrRenderComponent(_component_router_link, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="flex items-center hover:bg-[#FF852E] hover:bg-opacity-80 px-2 rounded-lg gap-2 h-12 cursor-pointer text-[#555555]" data-v-85ecf7dc${_scopeId}><img loading="lazy" class="w-5 h-5"${ssrRenderAttr("src", i.svg)} alt="" data-v-85ecf7dc${_scopeId}><p data-v-85ecf7dc${_scopeId}>${ssrInterpolate(i.name)}</p></div>`);
              } else {
                return [
        ...
        ssrRenderList(unref(group_settings), (i) => {
          _push(ssrRenderComponent(_component_router_link, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="${ssrRenderClass([{ "active": _ctx.$route.query.tab == i.url }, "flex items-center hover:bg-[#FF852E] hover:bg-opacity-80 px-2 rounded-lg gap-2 h-12 cursor-pointer text-[#555555]"])}" data-v-85ecf7dc${_scopeId}><img loading="lazy" class="w-5 h-5"${ssrRenderAttr("src", i.svg)} alt="" data-v-85ecf7dc${_scopeId}><p data-v-85ecf7dc${_scopeId}>${ssrInterpolate(i.name)}</p></div>`);
              } else {
                return [
                  createVNode("div", {
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-85ecf7dc"]]);
const _sfc_main$1 = {
  __name: "BottomBar",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_router_link = resolveComponent("router-link");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sc-bottom-bar" }, _attrs))} data-v-d17f2f09><!--[-->`);
      ssrRenderList(unref(sidebar), (i) => {
        _push(ssrRenderComponent(_component_router_link, {
          class: "sc-menu-item",
          to: i.url,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img loading="lazy" class="w-5 h-5"${ssrRenderAttr("src", i.svg)} alt="" data-v-d17f2f09${_scopeId}><span class="duration-1000 opacity-0 text" data-v-d17f2f09${_scopeId}>${ssrInterpolate(i.name)}</span>`);
            } else {
              return [
                createVNode("img", {
                  loading: "lazy",
                ...
                createVNode("span", { class: "duration-1000 opacity-0 text" }, toDisplayString(i.name), 1)
              ];
            }
          }),
          _: 2
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d17f2f09"]]);
const _imports_0 = "data:image/svg+xml,%3csvg%20width='79'%20height='19'%20viewBox='0%200%2079%2019'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M3.58984%2018H0.0507812V1.08984H3.58984V18ZM7.46875%2018V0.140625H10.8789V18H7.46875ZM14.4297%2018V5.07422H17.7344V7.18359H17.9453C18.2109%206.44141%2018.6602%205.85938%2019.293%205.4375C19.9336%205.00781%2020.6758%204.79297%2021.5195%204.79297C22.418%204.79297%2023.1719%205.00391%2023.7812%205.42578C24.3984%205.83984%2024.8359%206.42578%2025.0938%207.18359H25.3047C25.6094%206.45703%2026.1094%205.87891%2026.8047%205.44922C27.5%205.01172%2028.2969%204.79297%2029.1953%204.79297C30.4844%204.79297%2031.5039%205.18359%2032.2539%205.96484C33.0039%206.74609%2033.3789%207.80078%2033.3789%209.12891V18H29.9688V10.0312C29.9688%208.5%2029.25%207.73438%2027.8125%207.73438C27.125%207.73438%2026.5742%207.95312%2026.1602%208.39062C25.7461%208.82812%2025.5391%209.39453%2025.5391%2010.0898V18H22.2578V9.89062C22.2578%209.21094%2022.0703%208.68359%2021.6953%208.30859C21.3203%207.92578%2020.7969%207.73438%2020.125%207.73438C19.4609%207.73438%2018.9141%207.96875%2018.4844%208.4375C18.0547%208.90625%2017.8398%209.5%2017.8398%2010.2188V18H14.4297Z'%20fill='%23323232'/%3e%3cpath%20d='M40.4219%2018H37.0352V1.08984H39.9883L47.7695%2011.625H47.9805V1.08984H51.3672V18H48.4375L40.6328%207.41797H40.4219V18ZM66.8359%205.07422V18H63.5312V15.9258H63.3203C62.6797%2017.4961%2061.4219%2018.2812%2059.5469%2018.2812C58.1484%2018.2812%2057.043%2017.8594%2056.2305%2017.0156C55.4258%2016.1641%2055.0234%2014.9922%2055.0234%2013.5V5.07422H58.4336V12.6211C58.4336%2014.418%2059.2266%2015.3164%2060.8125%2015.3164C61.6484%2015.3164%2062.293%2015.0703%2062.7461%2014.5781C63.1992%2014.0859%2063.4258%2013.4023%2063.4258%2012.5273V5.07422H66.8359ZM70.2578%2018V5.07422H73.5625V7.13672H73.7734C73.9453%206.48047%2074.3359%205.9375%2074.9453%205.50781C75.5625%205.07812%2076.2773%204.86328%2077.0898%204.86328C77.6758%204.86328%2078.1211%204.91797%2078.4258%205.02734V8.13281C78.0664%207.99219%2077.5273%207.92188%2076.8086%207.92188C75.8633%207.92188%2075.1016%208.18359%2074.5234%208.70703C73.9531%209.23047%2073.668%209.94141%2073.668%2010.8398V18H70.2578Z'%20fill='%23FF852E'/%3e%3c/svg%3e";
const _sfc_main = {
  __name: "default",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isLoading).store.middleware) {
        ...
        if (unref(isLoading).store.isLogin || ["login", "verify-email"].includes(_ctx.$router.currentRoute.value.name)) {
          ...
          _push(`<div class="full_flex h-full py-20">`);
          _push(ssrRenderComponent(_component_router_link, { to: "/login" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button class="bg_main px-6 py-1 rounded-full"${_scopeId}>Login</button>`);
              } else {
                return [
                  createVNode("button", { class: "bg_main px-6 py-1 rounded-full" }, "Login")
                ];
              }
            }),
            _: 1
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_router_link, { to: "/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img loading="lazy" class="min-w-fit"${ssrRenderAttr("src", _imports_0)} alt=""${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      loading: "lazy",
...
//# sourceMappingURL=default-YZFX51Kk.mjs.map
