...
import { _ as _imports_0$2, a as _sfc_main$5 } from './back_route-DdywOhAi.mjs';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "min-w-[260px] h-[calc(100vh_-_140px)] overflow-y-auto noscroll md:p-4 bg-white r_8" }, _attrs))} data-v-28f8a8fc><ul class="space-y-7" data-v-28f8a8fc>`);
      if (unref(store).is_sidebar) {
        _push(ssrRenderComponent(_component_router_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img loading="lazy" class="pcursor"${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-28f8a8fc${_scopeId}><span data-v-28f8a8fc${_scopeId}>Orqaga</span>`);
            } else {
              return [
                createVNode("img", {
                  loading: "lazy",
      ...
      if (unref(isLoading).store.isLogin && !unref(store).is_sidebar) {
        _push(`<li class="flex items-center gap-1 w-full" data-v-28f8a8fc><div class="relative min-w-fit" data-v-28f8a8fc><div class="clip" data-v-28f8a8fc><div class="min-h-[53px] min-w-[53px] max-h-[53px] max-w-[53px]" data-v-28f8a8fc>`);
        ...
        _push(`</div></div><img loading="lazy" class="absolute rotate-[180deg] -bottom-1 -right-[1px]"${ssrRenderAttr("src", _imports_1)} alt="" data-v-28f8a8fc></div><ul class="max-w-[60%]" data-v-28f8a8fc><li class="font-bold whitespace-nowrap truncate" data-v-28f8a8fc><h1 class="truncate" data-v-28f8a8fc>${ssrInterpolate((_b = unref(isLoading).user) == null ? void 0 : _b.name)} ${ssrInterpolate((_c = unref(isLoading).user) == null ? void 0 : _c.surname)}</h1></li><li class="flex gap-1 pcursor font-medium text-sm c_c66" data-v-28f8a8fc><span data-v-28f8a8fc>id: ${ssrInterpolate((_d = unref(isLoading).user) == null ? void 0 : _d.id)}</span><img loading="lazy"${ssrRenderAttr("src", _imports_2)} alt="" data-v-28f8a8fc></li></ul><img loading="lazy" class=""${ssrRenderAttr("src", _imports_3$1)} alt="" data-v-28f8a8fc></li>`);
      } else {
        _push(`<!---->`);
      }
      if (_ctx.$router.currentRoute.value.path.includes("my_groups")) {
        _push(`<li data-v-28f8a8fc><!--[-->`);
        ssrRenderList(unref(group_sidebar), (i) => {
          _push(ssrRenderComponent(_component_router_link, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="flex items-center hover:bg-[#FF852E] hover:bg-opacity-80 px-2 rounded-lg gap-2 h-12 cursor-pointer text-[#555555]" data-v-28f8a8fc${_scopeId}><img loading="lazy" class="w-5 h-5"${ssrRenderAttr("src", i.svg)} alt="" data-v-28f8a8fc${_scopeId}><p data-v-28f8a8fc${_scopeId}>${ssrInterpolate(i.name)}</p></div>`);
              } else {
                return [
        ...
        ssrRenderList(unref(group_settings), (i) => {
          _push(ssrRenderComponent(_component_router_link, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="${ssrRenderClass([{ "active": _ctx.$route.query.tab == i.url }, "flex items-center hover:bg-[#FF852E] hover:bg-opacity-80 px-2 rounded-lg gap-2 h-12 cursor-pointer text-[#555555]"])}" data-v-28f8a8fc${_scopeId}><img loading="lazy" class="w-5 h-5"${ssrRenderAttr("src", i.svg)} alt="" data-v-28f8a8fc${_scopeId}><p data-v-28f8a8fc${_scopeId}>${ssrInterpolate(i.name)}</p></div>`);
              } else {
                return [
                  createVNode("div", {
        ...
        ssrRenderList(unref(sidebar), (i) => {
          var _a2;
          _push(`<!--[-->`);
          if (!((_a2 = i.role) == null ? void 0 : _a2.length) || i.role.includes(unref(isLoading).user.role)) {
            _push(ssrRenderComponent(_component_router_link, {
              to: i.url,
              key: i.id
            }, {
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-28f8a8fc"]]);
const _sfc_main$1 = {
  __name: "BottomBar",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_router_link = resolveComponent("router-link");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sc-bottom-bar" }, _attrs))} data-v-fd3a691b><!--[-->`);
      ssrRenderList(unref(sidebar), (i) => {
        var _a;
        _push(`<!--[-->`);
        if (!((_a = i.role) == null ? void 0 : _a.length) || i.role.includes(unref(isLoading).user.role)) {
          _push(ssrRenderComponent(_component_router_link, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<img loading="lazy" class="w-5 h-5"${ssrRenderAttr("src", i.svg)} alt="" data-v-fd3a691b${_scopeId}><span class="duration-1000 text" data-v-fd3a691b${_scopeId}>${ssrInterpolate(i.name)}</span>`);
              } else {
                return [
                  createVNode("img", {
                    loading: "lazy",
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-fd3a691b"]]);
...
//# sourceMappingURL=default-DqY9nbd9.mjs.map
