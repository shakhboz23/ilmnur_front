...
import { _ as _sfc_main$8 } from './Modal-Kmt9lhdy.mjs';
import { _ as _imports_0$2, a as _sfc_main$9 } from './back_route-xwsmbhNi.mjs';
import { a as _imports_4, _ as _imports_5 } from './editpen-D3lZHZ_O.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(activeKey) == 1) {
        _push(`<li>`);
        if (((_b = (_a = unref(useLessons).store.lessons) == null ? void 0 : _a.course) == null ? void 0 : _b.user_id) != ((_c = unref(isLoading).user) == null ? void 0 : _c.id) || ((_d = unref(isLoading).user) == null ? void 0 : _d.current_role) !== "admin") {
          _push(`<div>`);
          if ((_f = (_e = unref(useLessons).store.lessons) == null ? void 0 : _e.course) == null ? void 0 : _f.test_count) {
            _push(ssrRenderComponent(_component_router_link, {
          ...
          _push(`</div>`);
        } else if (((_h = (_g = unref(useLessons).store.lessons) == null ? void 0 : _g.course) == null ? void 0 : _h.user_id) == ((_i = unref(isLoading).user) == null ? void 0 : _i.id) && ((_j = unref(isLoading).user) == null ? void 0 : _j.current_role) == "admin") {
          _push(`<div>`);
          _push(ssrRenderComponent(_component_router_link, {
            to: `/test/${_ctx.$router.currentRoute.value.params.lesson_id}`,
            class: "full_flex bg-white"
        ...
        _push(ssrRenderComponent(_component_a_button, {
          ...
          class: ["full_flex gap-2 px-5 py-2 min-h-fit r_8 w-full truncate", ((_k = unref(useLessons).store.lessons) == null ? void 0 : _k.is_liked) ? "bg_main c_white" : "b_main c_main"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2;
            if (_push2) {
        ...
        _push(ssrRenderComponent(_component_a_button, {
          ...
          class: ["px-5 py-2 r_8 w-full min-h-fit truncate", ((_m = (_l = unref(useLessons).store.lessons) == null ? void 0 : _l.course) == null ? void 0 : _m.is_subscribed) ? "bg_main c_white" : "b_main c_main"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2;
            if (_push2) {
...
//# sourceMappingURL=index-B66DbulQ.mjs.map
