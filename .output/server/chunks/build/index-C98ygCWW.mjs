...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "shorts" }, _attrs))} data-v-6c0a66fb>`);
            ...
            ssrRenderList(unref(useLessons).store.all_lessons, (i) => {
              _push2(ssrRenderComponent(_component_swiper_slide, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex items-end border" data-v-6c0a66fb${_scopeId2}><div class="lg:w-full w-[calc(100%_-_50px)] md:h-[calc(100vh_-_160px)] h-[calc(100dvh_-_250px)] shadow-2xl" data-v-6c0a66fb${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_ClientOnly, null, {}, _parent3, _scopeId2));
                    _push3(`</div><ul class="flex flex-col lg:min-w-[60px] !min-w-[50px] md:px-2 justify-end items-end h-full text-center space-y-3" data-v-6c0a66fb${_scopeId2}><li data-v-6c0a66fb${_scopeId2}><button class="lg:p-0 p-2 bg_cf2 rounded-full" data-v-6c0a66fb${_scopeId2}><img class="lg:w-6 lg:h-6 w-4 h-4"${ssrRenderAttr("src", _imports_0)} alt="" data-v-6c0a66fb${_scopeId2}></button><p data-v-6c0a66fb${_scopeId2}>123</p></li><li data-v-6c0a66fb${_scopeId2}><button class="lg:p-0 p-2 bg_cf2 rounded-full" data-v-6c0a66fb${_scopeId2}><img class="lg:w-6 lg:h-6 w-4 h-4"${ssrRenderAttr("src", _imports_1)} alt="" data-v-6c0a66fb${_scopeId2}></button><p data-v-6c0a66fb${_scopeId2}>123</p></li><li data-v-6c0a66fb${_scopeId2}><button class="lg:p-0 p-2 bg_cf2 rounded-full" data-v-6c0a66fb${_scopeId2}><img class="lg:w-6 lg:h-6 w-4 h-4"${ssrRenderAttr("src", _imports_2)} alt="" data-v-6c0a66fb${_scopeId2}></button><p class="text-xs" data-v-6c0a66fb${_scopeId2}>share</p></li><li data-v-6c0a66fb${_scopeId2}><button class="lg:p-0 p-2 bg_cf2 rounded-full" data-v-6c0a66fb${_scopeId2}><img class="lg:w-6 lg:h-6 w-4 h-4"${ssrRenderAttr("src", _imports_3)} alt="" data-v-6c0a66fb${_scopeId2}></button></li><li data-v-6c0a66fb${_scopeId2}><button class="bg_cf2 rounded-full" data-v-6c0a66fb${_scopeId2}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6c0a66fb"]]);

export { index as default };
//# sourceMappingURL=index-C98ygCWW.mjs.map
