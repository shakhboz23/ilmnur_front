import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { _ as __nuxt_component_6 } from './HighChart-gpyKZg7l.mjs';
...
const __nuxt_component_1_lazy = defineAsyncComponent(() => import('./PieChart-BTiAvNC5.mjs').then((c) => c.default || c));
const _sfc_main = {
  __name: "Analytics",
...
//# sourceMappingURL=Analytics-3nQheiIe.mjs.map
