...
import { _ as _export_sfc, j as useCoursesStore, e as useLoadingStore, h as useLessonsStore, f as useCategoryStore, q as useSubscriptionStore, u as useRouter } from './server.mjs';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "r_12 overflow-hidden bg_white pcursor relative" }, _attrs))} data-v-65b1b241><div class="flex items-center justify-between gap-4" data-v-65b1b241><div class="flex items-center gap-4" data-v-65b1b241><img loading="lazy" class="w-10 h-10 object-cover r_8"${ssrRenderAttr("src", (_b = (_a = __props.subscriptions) == null ? void 0 : _a.course) == null ? void 0 : _b.cover)} alt="" data-v-65b1b241><h1 class="font-bold" data-v-65b1b241>${ssrInterpolate(__props.subscriptions.title)}</h1><div class="space-y-1" data-v-65b1b241><pre class="whitespace-pre-line line-clamp-2" data-v-65b1b241>${ssrInterpolate((_c = __props.subscriptions.course) == null ? void 0 : _c.description)}</pre><ul class="full_flex gap-1" data-v-65b1b241><li data-v-65b1b241> Private \u2022 1 member </li> \u2022 <li class="full_flex gap-1" data-v-65b1b241><img loading="lazy"${ssrRenderAttr("src", _imports_0)} alt="" data-v-65b1b241><span class="c_main" data-v-65b1b241>355</span></li> \u2022 <li class="font-semibold" data-v-65b1b241> $${ssrInterpolate((_d = __props.subscriptions.course) == null ? void 0 : _d.price)}</li></ul></div></div><button class="bg_main font-semibold py-2 px-6 r_8 h-10" data-v-65b1b241>Ko&#39;rish</button></div><div class="px-3 space-y-1 w-full" data-v-65b1b241>`);
      ...
      _push(`<p class="text-sm !-mt-2 pb-3" data-v-65b1b241>3/10 completed</p></div></div>`);
    };
  }
};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-65b1b241"]]);
const _sfc_main$1 = {
  __name: "Main",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-iBr77B6Q.mjs.map
