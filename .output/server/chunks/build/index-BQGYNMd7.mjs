import { _ as __nuxt_component_0$1 } from './CategorySlider-DeqTdbRv.mjs';
...
import { f as useCategoryStore, h as useLessonsStore, e as useLoadingStore, u as useRouter, k as useStripeStore, j as useCoursesStore, p as useChatStore, g as useAuthStore, q as useSubscriptionStore, s as useAttendanceStore, o as useGroupsStore, _ as _export_sfc } from './server.mjs';
import { _ as _imports_0$4, a as _sfc_main$n } from './back_route-DdywOhAi.mjs';
...
import { _ as _sfc_main$o } from './InfiniteScroll-mRHGMOo5.mjs';
...
import { _ as _sfc_main$p } from './Analytics-ChmTO6LT.mjs';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full" }, _attrs))}><nav class="w-full mb-4 space-y-3">`);
      _push(ssrRenderComponent(_component_CategorySlider, {
      ...
      _push(`<div class="flex items-center gap-3 min-w-fit"><button class="flex items-center justify-center h-[46px] w-[46px] rounded-[12px] bg_bg border border-transparent hover:border-gray-300 transition-all duration-200 active:scale-95"><img loading="lazy"${ssrRenderAttr("src", _imports_0$6)} alt="filter" class="w-5 h-5"></button><button class="h-[46px] px-14 rounded-[12px] text-sm font-semibold leading-4 bg_main text-white shadow-sm hover:shadow-md hover:brightness-105 active:scale-[0.98] transition-all duration-200"> Show result </button></div></nav><section class="space-y-4">`);
      ...
      ssrRenderList((_f = (_e = unref(useCourses).store.users) == null ? void 0 : _e[0]) == null ? void 0 : _f.subscriptions, (i, index) => {
...
//# sourceMappingURL=index-BQGYNMd7.mjs.map
