...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "h-screen full_flex" }, _attrs))} data-v-af507a9f><div class="my-auto py-10 md:px-0 px-4" data-v-af507a9f>`);
      _push(ssrRenderComponent(_component_LoadingComponent, {
        isloading: unref(isLoading).isLoadingType("auth")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="sm:w-[500px] bg_white mx-auto sm:p-[50px] p-5 pb-8 rounded-[16px]" data-v-af507a9f${_scopeId}><section data-v-af507a9f${_scopeId}><h1 class="text-center md:text-[28px] text-xl font-bold" data-v-af507a9f${_scopeId}> Tizimga kirish </h1><p class="_c42 text-center md:text-lg text-sm font-medium mt-4 mb-7" data-v-af507a9f${_scopeId}> Sizni qayta ko\u2018rganimizdan xursandmiz! </p></section><form class="space-y-6 text-sm" data-v-af507a9f${_scopeId}><div class="space-y-6" data-v-af507a9f${_scopeId}><div class="space-y-2" data-v-af507a9f${_scopeId}><label for="login" data-v-af507a9f${_scopeId}>Telefon raqam</label><div class="flex items-center relative" data-v-af507a9f${_scopeId}><input${ssrRenderAttr("value", unref(useAuth).login.phone)} type="tel" data-v-af507a9f${_scopeId}></div></div><div class="space-y-2" data-v-af507a9f${_scopeId}><label for="password" data-v-af507a9f${_scopeId}>Parol</label><div class="flex relative" data-v-af507a9f${_scopeId}><input${ssrRenderDynamicModel(unref(useAuth).store.passType, unref(useAuth).login.password, null)}${ssrRenderAttr("type", unref(useAuth).store.passType)} class="pr-10" data-v-af507a9f${_scopeId}>`);
            if (unref(useAuth).store.passType == "password") {
              _push2(`<img loading="lazy" class="absolute top-0 right-0 p-4 cursor-pointer"${ssrRenderAttr("src", _imports_0)} alt="" data-v-af507a9f${_scopeId}>`);
            } else {
              _push2(`<img loading="lazy" class="absolute top-0 right-0 p-4 cursor-pointer"${ssrRenderAttr("src", _imports_1)} alt="" data-v-af507a9f${_scopeId}>`);
            }
            _push2(`</div></div></div><p class="c_red font-medium" data-v-af507a9f${_scopeId}>${ssrInterpolate(unref(isLoading).store.error)}</p><div class="space-y-2 text-center mx-auto" data-v-af507a9f${_scopeId}><button class="bg_main px-10 py-3 mt-5 rounded-full text-white mx-auto" data-v-af507a9f${_scopeId}>Kirish</button></div><div class="full_flex" data-v-af507a9f${_scopeId}>`);
            ...
            _push2(`</div><div class="pt-2 space-y-6 grid" data-v-af507a9f${_scopeId}><p class="sm:w-[284px] text-[#323232] text-sm mx-auto text-center" data-v-af507a9f${_scopeId}> Davom etish orqali <span class="c_main border-b border-[#FF852E]" data-v-af507a9f${_scopeId}>Foydalanish shartlari</span> ga roziligingizni bildirasiz. </p></div></form></div>`);
          } else {
            return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-af507a9f"]]);

export { index as default };
//# sourceMappingURL=index-NK9PX5jS.mjs.map
