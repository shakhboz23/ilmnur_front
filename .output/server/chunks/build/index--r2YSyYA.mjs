...
import { _ as __nuxt_component_1 } from './Card-D6hP8oJb.mjs';
import { _ as _sfc_main$j } from './Modal-CNknc8lN.mjs';
import { _ as _imports_2$1, a as _imports_0$5, b as _sfc_main$k } from './time-DQ0ORrm0.mjs';
...
import { f as useCategoryStore, h as useLessonsStore, e as useLoadingStore, u as useRouter, k as useStripeStore, j as useCoursesStore, q as useChatStore, g as useAuthStore, l as useSubscriptionStore, s as useAttendanceStore, p as useGroupsStore, _ as _export_sfc } from './server.mjs';
import { _ as _imports_0$4, a as _sfc_main$n } from './back_route-DYkfboeQ.mjs';
...
import { _ as _sfc_main$o } from './InfiniteScroll-fUWC9gWP.mjs';
...
import { _ as _sfc_main$p } from './Analytics-3nQheiIe.mjs';
...
const _sfc_main$e = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "overflow-hidden" }, _attrs))} data-v-4f7f4801><nav class="flex items-center justify-between w-full mb-6" data-v-4f7f4801><div class="flex items-center" data-v-4f7f4801><div class="flex items-center justify-center cursor-pointer rounded-[4px] h-6 w-6 bg-[#EEEDF2] relative" data-v-4f7f4801><img loading="lazy" class="rotate-90"${ssrRenderAttr("src", _imports_3$2)} alt="" data-v-4f7f4801></div><p class="font-medium text-center text-2xl leading-7 w-[270px]" data-v-4f7f4801>${ssrInterpolate(months[unref(store).month])} ${ssrInterpolate(unref(store).year)}</p><div class="flex items-center justify-center cursor-pointer rounded-[4px] h-6 w-6 bg-[#EEEDF2]" data-v-4f7f4801><img loading="lazy" class="-rotate-90"${ssrRenderAttr("src", _imports_3$2)} alt="" data-v-4f7f4801></div></div><div class="flex gap-3" data-v-4f7f4801><div class="flex items-center bg-[#E6F2FF] h-[46px] w-[92px] rounded-[10px]" data-v-4f7f4801><button class="${ssrRenderClass([unref(store).sliderShow == 1 ? "bg-[#027DFC]" : "", "flex items-center justify-center h-[46px] w-[46px] rounded-[10px]"])}" data-v-4f7f4801><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4f7f4801><path d="M3 3H11.1V11.1H3V3ZM4.8 4.8V9.3H9.3V4.8H4.8ZM3 12.9H11.1V21H3V12.9ZM4.8 14.7V19.2H9.3V14.7H4.8ZM12.9 3H21V11.1H12.9V3ZM14.7 4.8V9.3H19.2V4.8H14.7ZM12.9 12.9H21V21H12.9V12.9ZM14.7 14.7V19.2H19.2V14.7H14.7Z"${ssrRenderAttr("fill", unref(store).sliderShow == 2 ? "#027DFC" : "#FFFFFF")} data-v-4f7f4801></path></svg></button><button class="${ssrRenderClass([unref(store).sliderShow == 2 ? "bg-[#027DFC]" : "", "flex items-center justify-center h-[46px] w-[46px] rounded-[10px]"])}" data-v-4f7f4801><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4f7f4801><path d="M21 9.6L21 5.6C21 5.17565 20.842 4.76869 20.5607 4.46863C20.2794 4.16857 19.8978 4 19.5 4L4.5 4C4.10217 4 3.72064 4.16857 3.43934 4.46863C3.15804 4.76869 3 5.17565 3 5.6L3 9.6C3 10.0243 3.15803 10.4313 3.43934 10.7314C3.72064 11.0314 4.10217 11.2 4.5 11.2L19.5 11.2C19.8978 11.2 20.2794 11.0314 20.5607 10.7314C20.842 10.4313 21 10.0243 21 9.6ZM4.6 9.6C4.54477 9.6 4.5 9.55523 4.5 9.5L4.5 5.7C4.5 5.64477 4.54477 5.6 4.6 5.6L19.4 5.6C19.4552 5.6 19.5 5.64477 19.5 5.7L19.5 9.5C19.5 9.55523 19.4552 9.6 19.4 9.6L4.6 9.6ZM21 18.4L21 14.4C21 13.9757 20.842 13.5687 20.5607 13.2686C20.2794 12.9686 19.8978 12.8 19.5 12.8L4.5 12.8C4.10217 12.8 3.72064 12.9686 3.43934 13.2686C3.15803 13.5687 3 13.9757 3 14.4L3 18.4C3 18.8243 3.15803 19.2313 3.43934 19.5314C3.72064 19.8314 4.10217 20 4.5 20L19.5 20C19.8978 20 20.2794 19.8314 20.5607 19.5314C20.842 19.2313 21 18.8243 21 18.4ZM4.6 18.4C4.54477 18.4 4.5 18.3552 4.5 18.3L4.5 14.5C4.5 14.4448 4.54477 14.4 4.6 14.4L19.4 14.4C19.4552 14.4 19.5 14.4448 19.5 14.5L19.5 18.3C19.5 18.3552 19.4552 18.4 19.4 18.4L4.6 18.4Z"${ssrRenderAttr("fill", unref(store).sliderShow == 1 ? "#027DFC" : "#FFFFFF")} data-v-4f7f4801></path></svg></button></div><button class="h-[46px] px-[56px] rounded-[10px] text-sm leading-4 bg-[#027DFC] text-white" data-v-4f7f4801> + Add event </button></div></nav><div id="mainSlider" class="flex" data-v-4f7f4801><section class="min-w-full space-y-[6px] calendar" data-v-4f7f4801><div class="grid grid-cols-7 gap-[6px] opacity-40" data-v-4f7f4801><!--[-->`);
      ssrRenderList(weeks, (i) => {
        _push(`<p class="leading-[15px] text-end" data-v-4f7f4801>${ssrInterpolate(i)}</p>`);
      });
      _push(`<!--]--></div><!--[-->`);
      ssrRenderList(unref(store).calendar, (i) => {
        _push(`<div class="grid grid-cols-7 gap-[6px]" data-v-4f7f4801><!--[-->`);
        ssrRenderList(i, (date, dateIndex) => {
          ...
          }, "flex justify-between cursor-pointer p-[10px] rounded-lg h-[113px]"])}" data-v-4f7f4801><div class="grid grid-cols-2 gap-[10px] max-h-[113px] overflow-hidden overflow-y-auto" data-v-4f7f4801><!--[-->`);
          ssrRenderList(+date[1], (i2, index) => {
            _push(`<div class="${ssrRenderClass([index % 2 != 0 ? "ml-[15px]" : "", "flex items-center justify-center bg-[#FF4D4D1A] h-6 w-6 rounded-full"])}" data-v-4f7f4801>`);
            _push(ssrRenderComponent(_component_a_tooltip, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt="" data-v-4f7f4801${_scopeId}>`);
                } else {
                  return [
                    createVNode("img", {
                      loading: "lazy",
          ...
          _push(`<!--]--></div><p class="${ssrRenderClass([date[0] != unref(store).month ? "opacity-20" : "", "font-medium leading-[19px]"])}" data-v-4f7f4801>${ssrInterpolate(date[1])}</p></div>`);
        });
        _push(`<!--]--></div>`);
      });
      _push(`<!--]--><div class="flex gap-10 items-center pt-6" data-v-4f7f4801><div class="flex gap-[8px] items-center" data-v-4f7f4801><div class="flex justify-center items-center bg-[#FDF8E9] h-6 w-6 rounded-full" data-v-4f7f4801><img loading="lazy" class="h-4 w-4"${ssrRenderAttr("src", _imports_2$1)} alt="" data-v-4f7f4801></div><p class="text-sm leading-[15px] font-medium" data-v-4f7f4801>Appointment</p></div><div class="flex gap-[8px] items-center" data-v-4f7f4801><div class="flex justify-center items-center bg-[#027DFC1A] h-6 w-6 rounded-full" data-v-4f7f4801><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-4f7f4801></div><p class="text-sm leading-[15px] font-medium" data-v-4f7f4801>Event</p></div><div class="flex gap-[8px] items-center" data-v-4f7f4801><div class="flex justify-center items-center bg-[#FF4D4D1A] h-6 w-6 rounded-full" data-v-4f7f4801><img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt="" data-v-4f7f4801></div><p class="text-sm leading-[15px] font-medium" data-v-4f7f4801>Case deadline</p></div><div class="flex gap-[8px] items-center" data-v-4f7f4801><div class="flex justify-center items-center bg-[#13C1B71A] h-6 w-6 rounded-full" data-v-4f7f4801><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-4f7f4801></div><p class="text-sm leading-[15px] font-medium" data-v-4f7f4801>Birthday</p></div></div></section><section class="flex gap-[26px] min-w-full" data-v-4f7f4801><div class="min-w-[316px] space-y-4" data-v-4f7f4801><div class="grid grid-rows-6 py-[27px] rounded-lg bg-[#F4F3F9] px-6 w-full h-[250px]" data-v-4f7f4801><div class="grid grid-cols-7 row-span-1 text-center" data-v-4f7f4801><!--[-->`);
      ssrRenderList(weeks, (i) => {
        _push(`<p class="text-[10px] leading-4 text-[#71717A]" data-v-4f7f4801>${ssrInterpolate(i)}</p>`);
      });
      _push(`<!--]--></div><div class="grid grid-cols-7 font-medium row-span-5 text-center" data-v-4f7f4801><!--[-->`);
      ssrRenderList(unref(store).days, (i) => {
        _push(`<div class="${ssrRenderClass([i == 15 ? "bg-[#11253B] text-white" : "", "flex flex-col items-center justify-center hover:bg-[#11253B] hover:text-white cursor-pointer duration-500 text-[11px] w-7 h-7 mx-auto rounded-lg"])}" data-v-4f7f4801><p class="leading-4" data-v-4f7f4801>${ssrInterpolate(i)}</p><p class="flex gap-[2px] justify-center" data-v-4f7f4801><span class="h-1 w-1 inline-block bg-[#EEB627] rounded-full" data-v-4f7f4801></span><span class="h-1 w-1 inline-block bg-[#13C1B7] rounded-full" data-v-4f7f4801></span><span class="h-1 w-1 inline-block bg-[#FF0000] rounded-full" data-v-4f7f4801></span></p></div>`);
      });
      _push(`<!--]--></div></div><div class="bg-[#F4F3F9] rounded-lg px-5 py-8" data-v-4f7f4801><h1 class="text-[11px] font-bold leading-[11px] uppercase mb-4" data-v-4f7f4801> Show calendar by </h1><div class="flex items-center gap-4" data-v-4f7f4801><button class="flex items-center justify-center border border-[#027DFC] rounded-2xl h-8 px-[14px]" data-v-4f7f4801> Day </button><button class="flex items-center justify-center border border-[#027DFC] bg-[#027DFC] text-white rounded-2xl h-8 px-[14px]" data-v-4f7f4801> Week </button><button class="flex items-center justify-center border border-[#027DFC] rounded-2xl h-8 px-[14px]" data-v-4f7f4801> Month </button></div></div><div class="grid grid-cols-2 px-5 py-6 gap-5 bg-[#F4F3F9] rounded-lg" data-v-4f7f4801><div class="flex gap-[8px] items-center" data-v-4f7f4801><div class="flex justify-center items-center bg-[#FDF8E9] h-6 w-6 rounded-full" data-v-4f7f4801><img loading="lazy" class="h-4 w-4"${ssrRenderAttr("src", _imports_2$1)} alt="" data-v-4f7f4801></div><p class="text-sm leading-[15px] font-medium" data-v-4f7f4801>Appointment</p></div><div class="flex gap-[8px] items-center" data-v-4f7f4801><div class="flex justify-center items-center bg-[#027DFC1A] h-6 w-6 rounded-full" data-v-4f7f4801><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-4f7f4801></div><p class="text-sm leading-[15px] font-medium" data-v-4f7f4801>Event</p></div><div class="flex gap-[8px] items-center" data-v-4f7f4801><div class="flex justify-center items-center bg-[#FF4D4D1A] h-6 w-6 rounded-full" data-v-4f7f4801><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-4f7f4801></div><p class="text-sm leading-[15px] font-medium" data-v-4f7f4801>Case deadline</p></div><div class="flex gap-[8px] items-center" data-v-4f7f4801><div class="flex justify-center items-center bg-[#13C1B71A] h-6 w-6 rounded-full" data-v-4f7f4801><img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt="" data-v-4f7f4801></div><p class="text-sm leading-[15px] font-medium" data-v-4f7f4801>Birthday</p></div></div></div><div class="flex gap-3 w-full max-w-calc" data-v-4f7f4801><ul class="space-y-[50px] text-[#999999] text-sm font-medium leading-6 mt-[77px]" data-v-4f7f4801><!--[-->`);
      ssrRenderList(12, (i) => {
        _push(`<li data-v-4f7f4801>${ssrInterpolate(i + 6)}:00</li>`);
      });
      _push(`<!--]--></ul><div class="flex gap-[14px] overflow-hidden overflow-x-auto min-w-full max-w-[calc(100vh_-_490px)]" data-v-4f7f4801><!--[-->`);
      ssrRenderList(7, (i) => {
        _push(`<div class="bg-[#F4F3F9] font-medium rounded-lg py-[10px] w-[200px] h-full" data-v-4f7f4801><h1 class="text-sm leading-[15px] px-[10px] opacity-40" data-v-4f7f4801>Mon</h1><p class="text-2xl leading-7 px-[10px] mt-1 mb-[22px]" data-v-4f7f4801>${ssrInterpolate(i + 6)}</p><div class="flex gap-3 py-[6px] bg-[#DEEEF2] h-[75px]" data-v-4f7f4801><p class="min-w-[5px] bg-[#13C1B7] -my-[6px] min-h-full" data-v-4f7f4801></p><div data-v-4f7f4801><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-4f7f4801><p class="text-xs mt-2 leading-[14px] whitespace-nowrap truncate w-[85%] font-medium" data-v-4f7f4801> Jack Johnson birthday text text text </p></div></div><div class="flex gap-3 py-[6px] bg-[#F5DBE0] h-[75px]" data-v-4f7f4801><p class="min-w-[5px] bg-[#FF4C4C] -my-[6px] min-h-full" data-v-4f7f4801></p><div data-v-4f7f4801><img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt="" data-v-4f7f4801><p class="text-xs mt-2 leading-[14px] whitespace-nowrap truncate w-[85%] font-medium" data-v-4f7f4801> This is a name of the case </p><p class="text-[#027DFC] mt-[6px] text-sm leading-[14px] font-medium" data-v-4f7f4801> #00253 </p></div></div></div>`);
      });
      ...
      _push(ssrRenderComponent(_component_a_modal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<form class="space-y-5" data-v-4f7f4801${_scopeId}><h1 class="text-2xl pb-2 font-semibold _c07" data-v-4f7f4801${_scopeId}>`);
            if (_ctx.$t("nav.uz") != "uz") {
              _push2(`<span data-v-4f7f4801${_scopeId}>`);
              if (unref(store).editEventModal) {
                _push2(`<span data-v-4f7f4801${_scopeId}>${ssrInterpolate(_ctx.$t("edit"))}</span>`);
              } else {
                _push2(`<span data-v-4f7f4801${_scopeId}>${ssrInterpolate(_ctx.$t("add"))}</span>`);
              }
              _push2(`</span>`);
            } else {
              _push2(`<!---->`);
            ...
            if (_ctx.$t("nav.uz") == "uz") {
              _push2(`<span class="lowercase" data-v-4f7f4801${_scopeId}>`);
              if (unref(store).editEventModal) {
                _push2(`<span data-v-4f7f4801${_scopeId}>${ssrInterpolate(_ctx.$t("edit"))}</span>`);
              } else {
                _push2(`<span data-v-4f7f4801${_scopeId}>${ssrInterpolate(_ctx.$t("add"))}</span>`);
            ...
            _push2(`</h1><div data-v-4f7f4801${_scopeId}>`);
            ...
            _push2(`<p class="text-end mt-1 _ca1 text-sm" data-v-4f7f4801${_scopeId}></p></div><div class="grid md:grid-cols-5 grid-cols-2 flex-wrap items-center gap-2" data-v-4f7f4801${_scopeId}><div class="flex items-center !min-w-full" data-v-4f7f4801${_scopeId}>`);
            _push2(ssrRenderComponent(_component_a_date_picker, {
              ...
              suffixIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img class="w-4"${ssrRenderAttr("src", _imports_3$2)} alt="" data-v-4f7f4801${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      class: "w-4",
            ...
            _push2(`</div><div class="w-full" data-v-4f7f4801${_scopeId}>`);
            _push2(ssrRenderComponent(_component_a_select, {
              class: "w-full",
              onChange: _ctx.checkIsActive,
                ...
                if (_push3) {
                  ...
                  ssrRenderList(time_list, (item2) => {
                    _push3(ssrRenderComponent(_component_a_option, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex items-center gap-2" data-v-4f7f4801${_scopeId3}>${ssrInterpolate(item2)} `);
                          if (unref(create).time == item2) {
                            _push4(`<img${ssrRenderAttr("src", _imports_3$3)} alt="" data-v-4f7f4801${_scopeId3}>`);
                          } else {
                            _push4(`<!---->`);
                          }
                          _push4(`</div>`);
            ...
            _push2(`</div><div class="w-full md:col-span-1 col-span-2" data-v-4f7f4801${_scopeId}>`);
            _push2(ssrRenderComponent(_component_a_select, {
              class: "w-full",
              onChange: _ctx.checkIsActive,
                ...
                if (_push3) {
                  ...
                  ssrRenderList(48, (item2) => {
                    _push3(ssrRenderComponent(_component_a_option, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex items-center gap-2" data-v-4f7f4801${_scopeId3}>${ssrInterpolate(item2 / 2)} ${ssrInterpolate(item2 / 2 == 1 ? "hour" : "hours")} `);
            ...
            _push2(`</div><div class="w-full col-span-2 timezone" data-v-4f7f4801${_scopeId}>`);
            _push2(ssrRenderComponent(_component_a_select, {
            ...
            if (unref(store).recurring) {
              _push2(`<div data-v-4f7f4801${_scopeId}><div class="flex items-center gap-5" data-v-4f7f4801${_scopeId}><p data-v-4f7f4801${_scopeId}>Repeat every</p>`);
              _push2(ssrRenderComponent(_component_a_select, {
                  ...
                  if (_push3) {
                    ...
                    ssrRenderList(Object.keys(repeat_data), (item2) => {
                      _push3(ssrRenderComponent(_component_a_option, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="flex items-center gap-2 capitalize" data-v-4f7f4801${_scopeId3}>${ssrInterpolate(item2)} `);
                            if (unref(create).timezone == item2) {
                              _push4(`<img${ssrRenderAttr("src", _imports_3$3)} alt="" data-v-4f7f4801${_scopeId3}>`);
                            } else {
                              _push4(`<!---->`);
              ...
              if (unref(create).repeat == "month" || unref(create).repeat == "week") {
                _push2(`<div class="mt-6" data-v-4f7f4801${_scopeId}><p data-v-4f7f4801${_scopeId}>Repeat on</p><div class="flex items-center gap-0" data-v-4f7f4801${_scopeId}><!--[-->`);
              ...
              _push2(`<div class="mt-6" data-v-4f7f4801${_scopeId}><p data-v-4f7f4801${_scopeId}>End</p><div class="!space-y-6 mt-4" data-v-4f7f4801${_scopeId}><label for="never" class="flex items-center gap-4" data-v-4f7f4801${_scopeId}><input class="w-5" type="radio" name="end" id="never" data-v-4f7f4801${_scopeId}><p data-v-4f7f4801${_scopeId}>Never</p></label><label for="on" class="flex items-center gap-4" data-v-4f7f4801${_scopeId}><input class="w-5" type="radio" name="end" id="on" data-v-4f7f4801${_scopeId}><p class="flex items-center" data-v-4f7f4801${_scopeId}><span class="block min-w-[60px]" data-v-4f7f4801${_scopeId}>On</span>`);
              _push2(ssrRenderComponent(_component_a_date_picker, {
                onChange: _ctx.checkIsActive,
                modelValue: unref(create).date,
                "onUpdate:modelValue": ($event) => unref(create).date = $event,
              ...
              _push2(`</p></label><label for="after" class="flex items-center gap-4" data-v-4f7f4801${_scopeId}><input class="w-5" type="radio" name="end" id="after" data-v-4f7f4801${_scopeId}><p class="flex items-center" data-v-4f7f4801${_scopeId}><span class="block min-w-[60px]" data-v-4f7f4801${_scopeId}>After</span><input type="number" class="w-20" data-v-4f7f4801${_scopeId}><span class="block ml-2" data-v-4f7f4801${_scopeId}>occurrences</span></p></label></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="flex md:flex-row flex-col md:items-center gap-4" data-v-4f7f4801${_scopeId}><div data-v-4f7f4801${_scopeId}><label class="_ca1 block mb-2 text-xs" for="location" data-v-4f7f4801${_scopeId}>Location</label>`);
            _push2(ssrRenderComponent(_component_a_dropdown, { class: "dropdown !h-[50px] b_ccc rounded-xl px-3 !w-full" }, {
                        ...
                        ssrRenderList(location_list, (item2) => {
                          _push4(ssrRenderComponent(_component_a_menu_item, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="flex items-center !gap-2" data-v-4f7f4801${_scopeId4}><img${ssrRenderAttr("src", item2.value)} alt="" data-v-4f7f4801${_scopeId4}><p data-v-4f7f4801${_scopeId4}>${ssrInterpolate(item2.label)}</p></div>`);
                              } else {
                                return [
                                  createVNode("div", { class: "flex items-center !gap-2" }, [
                                    createVNode("img", {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2, _c2, _d2;
                if (_push3) {
                  _push3(`<div class="flex items-center justify-between w-full min-w-[132px]" data-v-4f7f4801${_scopeId2}><div class="flex items-center !md:w-[132px] !w-full gap-2" data-v-4f7f4801${_scopeId2}><img${ssrRenderAttr("src", (_a2 = unref(create).location) == null ? void 0 : _a2.value)} alt="" data-v-4f7f4801${_scopeId2}> ${ssrInterpolate((_b2 = unref(create).location) == null ? void 0 : _b2.label)}</div><img${ssrRenderAttr("src", _imports_3$2)} alt="" data-v-4f7f4801${_scopeId2}></div>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="w-full" data-v-4f7f4801${_scopeId}><label class="_ca1 block mb-2 text-xs" for="location" data-v-4f7f4801${_scopeId}>${ssrInterpolate(((_a = unref(create).location) == null ? void 0 : _a.label) != "Link" ? ((_b = unref(create).location) == null ? void 0 : _b.label) + " link" : (_c = unref(create).location) == null ? void 0 : _c.label)}</label><input${ssrRenderAttr("value", unref(create).location_value)} type="text" class="!font-[400]"${ssrRenderAttr("placeholder", _ctx.$t("calendar.enterurl"))} data-v-4f7f4801${_scopeId}></div></div><div data-v-4f7f4801${_scopeId}><textarea id="write_message" class="h-[90px] text-sm w-full rounded-[4px]"${ssrRenderAttr("placeholder", _ctx.$t("description"))} data-v-4f7f4801${_scopeId}>${ssrInterpolate(unref(create).description)}</textarea><p class="text-end mt-2 _ca1 text-sm" data-v-4f7f4801${_scopeId}>${ssrInterpolate((_d = unref(create).description) == null ? void 0 : _d.length)}/300 </p></div><div class="sm:flex gap-4 sm:w-full w-[366px] max-w-full" data-v-4f7f4801${_scopeId}><div data-v-4f7f4801${_scopeId}>`);
            if (!((_e = unref(isLoading).store) == null ? void 0 : _e.croppedImage)) {
              _push2(`<label for="add_photo_event" class="full_flex flex-col gap-1 cursor-pointer _c2a bg_cf2 rounded-xl font-medium text-sm sm:h-[188px] h-[164px] w-[366px] max-w-full" data-v-4f7f4801${_scopeId}><img${ssrRenderAttr("src", _imports_5)} alt="" data-v-4f7f4801${_scopeId}><p class="c_main" data-v-4f7f4801${_scopeId}>Upload cover image</p><p class="c_ca1 text-xs font-medium" data-v-4f7f4801${_scopeId}>1460 x 752 px</p></label>`);
            } else {
              _push2(`<label class="relative imagelabel" for="add_photo_event" data-v-4f7f4801${_scopeId}><button type="button" class="absolute deleteimage !hidden top-2 right-2 rounded-full w-7 h-7 full_flex border p-2" data-v-4f7f4801${_scopeId}><img${ssrRenderAttr("src", _imports_1$2)} alt="" data-v-4f7f4801${_scopeId}></button><img class="sm:h-[188px] h-[164px] w-[366px] max-w-full overflow-hidden rounded-xl object-cover"${ssrRenderAttr("src", unref(isLoading).store.croppedImage)} alt="" data-v-4f7f4801${_scopeId}></label>`);
            }
            _push2(`</div><div class="py-5 space-y-5 w-full" data-v-4f7f4801${_scopeId}><div class="w-full" data-v-4f7f4801${_scopeId}><label class="_ca1 text-xs" for="access" data-v-4f7f4801${_scopeId}>Who can attend this event</label>`);
            _push2(ssrRenderComponent(_component_a_select, {
                ...
                if (_push3) {
                  ...
                  ssrRenderList(access_list, (item2) => {
                    _push3(ssrRenderComponent(_component_a_option, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex items-center gap-2" data-v-4f7f4801${_scopeId3}>${ssrInterpolate(_ctx.$t(`calendar.${item2.label}`))} `);
            ...
            if (unref(create).access == "level") {
              _push2(`<div data-v-4f7f4801${_scopeId}><label class="_ca1 text-xs" for="access" data-v-4f7f4801${_scopeId}>${ssrInterpolate(_ctx.$t("calendar.levelstart"))}</label>`);
              _push2(ssrRenderComponent(_component_a_select, {
            ...
            _push2(`</div><div class="file_input" data-v-4f7f4801${_scopeId}><input id="add_photo_event" type="file" accept="image/*" data-v-4f7f4801${_scopeId}></div></div><div class="flex items-center justify-between sm:pt-3 !sm:mt-8 !mt-5 text-sm font-semibold whitespace-nowrap" data-v-4f7f4801${_scopeId}>`);
            if (unref(store).editEventModal) {
              _push2(`<button${ssrRenderAttrs(mergeProps({
                type: "button",
                class: "uppercase h-10 px-6 rounded-lg _ceb"
              }, ssrGetDirectiveProps(_ctx, _directive_loading, unref(isLoading).isLoadingType("deleteEvent"))))} data-v-4f7f4801${_scopeId}>${ssrInterpolate(_ctx.$t("calendar.delete"))}</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="flex justify-end w-full gap-3" data-v-4f7f4801${_scopeId}><button type="button" class="uppercase h-10 px-6 rounded-lg _ca1" data-v-4f7f4801${_scopeId}>${ssrInterpolate(_ctx.$t("cancel"))}</button><button${ssrRenderAttrs(mergeProps({
            ...
            }, ssrGetDirectiveProps(_ctx, _directive_loading, unref(isLoading).isLoadingType("addEvents"))))} data-v-4f7f4801${_scopeId}>`);
            if (unref(store).editEventModal) {
              _push2(`<span data-v-4f7f4801${_scopeId}>${ssrInterpolate(_ctx.$t("save"))}</span>`);
            } else {
              _push2(`<span data-v-4f7f4801${_scopeId}>${ssrInterpolate(_ctx.$t("add"))}</span>`);
            }
...
const __nuxt_component_6$1 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-4f7f4801"]]);
const _sfc_main$d = {};
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-a780773b"]]);
const _sfc_main$6 = {
  __name: "Analytics",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index--r2YSyYA.mjs.map
