...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex items-center justify-between gap-4 w-full" }, _attrs))} data-v-593306c8><div class="stack-tab-container xl:w-full w-[90%] pr-6" data-v-593306c8>`);
      if (unref(isLoading).isLoadingType("category")) {
        _push(`<div class="flex gap-5" data-v-593306c8><!--[-->`);
        ssrRenderList(12, (i) => {
          _push(`<button class="r_20 overflow-hidden" data-v-593306c8>`);
          _push(ssrRenderComponent(_component_LoadingDiv, { class: "w-20 h-full min-h-[34px] r_f" }, null, _parent));
          _push(`</button>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<div class="tab-bar whitespace-nowrap" data-v-593306c8><button class="left-arrow" data-v-593306c8><img loading="lazy" class="rotate-90"${ssrRenderAttr("src", _imports_3)} alt="" data-v-593306c8></button><ul class="tabs" data-v-593306c8>`);
        if (__props.all) {
          _push(`<button class="${ssrRenderClass([((_c = JSON.parse(typeof ((_a = unref(router).currentRoute.value.query) == null ? void 0 : _a.subcategory_id) == "string" ? (_b = unref(router).currentRoute.value.query) == null ? void 0 : _b.subcategory_id : "[]")) == null ? void 0 : _c.length) == 0 ? "bg_main c_white" : "c_main", "duration-700 r_20 py-2 px-3 text-xs b_main"])}" data-v-593306c8>All</button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
        ssrRenderList(__props.category, (i) => {
          var _a2, _b2, _c2;
          _push(`<button style="${ssrRenderStyle((__props.subcategory_id ? __props.subcategory_id == i.id : true) ? null : { display: "none" })}" class="${ssrRenderClass([((_c2 = JSON.parse(typeof ((_a2 = unref(router).currentRoute.value.query) == null ? void 0 : _a2.subcategory_id) == "string" ? (_b2 = unref(router).currentRoute.value.query) == null ? void 0 : _b2.subcategory_id : "[]")) == null ? void 0 : _c2.includes(i.id)) ? "bg_main c_white" : "c_main", "duration-700 r_20 py-2 px-3 text-xs b_main"])}" data-v-593306c8>${ssrInterpolate(i.category || i.title)}</button>`);
        });
        _push(`<!--]--></ul><button class="right-arrow active" data-v-593306c8><img loading="lazy" class="-rotate-90"${ssrRenderAttr("src", _imports_3)} alt="" data-v-593306c8></button></div>`);
      }
      _push(`</div><button class="w-9 h-9 r_8 min-w-fit full_flex bg_cf5" data-v-593306c8><img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt="" data-v-593306c8></button></div>`);
    };
  }
};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-593306c8"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=CategorySlider-DeqTdbRv.mjs.map
