...
import { _ as __nuxt_component_6 } from './HighChart-DYcIgaHu.mjs';
...
import { e as useLoadingStore, q as useGroupsStore, f as useCategoryStore, s as useWatchedStore } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading).isLoadingType("groups")) {
        ...
        ssrRenderList((_m = unref(useGroups).store.groups) == null ? void 0 : _m.groups, (i) => {
...
//# sourceMappingURL=index-qa3fFdsl.mjs.map
