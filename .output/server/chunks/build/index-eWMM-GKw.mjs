import { _ as __nuxt_component_0$1 } from './CategorySlider-8AhtmmPq.mjs';
import { _ as __nuxt_component_0$2 } from './LoadingDiv-BWSiFsIO.mjs';
import { _ as __nuxt_component_1 } from './Card-BK_fjzyg.mjs';
import { _ as _sfc_main$j } from './Modal-CNknc8lN.mjs';
import { _ as _imports_2$1, a as _imports_0$5, b as _sfc_main$k } from './time-CtCPPGEw.mjs';
import { _ as _sfc_main$l } from './DeleteModal-CRgYI_wN.mjs';
...
import { f as useCategoryStore, h as useLessonsStore, e as useLoadingStore, u as useRouter, k as useStripeStore, j as useCoursesStore, o as useChatStore, g as useAuthStore, p as useSubscriptionStore, q as useGroupsStore, _ as _export_sfc } from './server.mjs';
import { _ as _imports_0$4, a as _sfc_main$n } from './back_route-D4cHSbpK.mjs';
...
import { _ as _sfc_main$m } from './Avatar-ppAiHF0k.mjs';
import { _ as _imports_0$6 } from './filter-GR5HalyB.mjs';
import { _ as _sfc_main$o } from './InfiniteScroll-DXtAoFID.mjs';
...
import { _ as _sfc_main$p } from './Analytics-C899BjVo.mjs';
...
const _sfc_main$i = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UIModal = _sfc_main$j;
      const _component_ModalCreateCourse = _sfc_main$k;
      const _component_UIDeleteModal = _sfc_main$l;
      ...
      if (unref(isLoading).isLoadingType("getByCourse")) {
        ...
        _push(`<!--]-->`);
        if (unref(isLoading).user.id == unref(isLoading).store.owner_id) {
      ...
      _push(`</section>`);
      if (!((_b = _ctx.$route.query) == null ? void 0 : _b.tab)) {
...
const _sfc_main$f = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_CategorySlider = __nuxt_component_0$1;
      const _component_UIAvatar = _sfc_main$m;
      const _component_UIModal = _sfc_main$j;
        ...
        _push(ssrRenderComponent(_component_UIModal, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              ...
              _push2(`<div class="col-span-2 space-y-2"${_scopeId}><h1 class="font-bold"${_scopeId}>Role</h1> ${ssrInterpolate(unref(useAuth).user.role)} `);
              _push2(ssrRenderComponent(_component_a_select, {
                class: "w-full",
                value: unref(useAuth).user.role,
                "onUpdate:value": ($event) => unref(useAuth).user.role = $event,
                "show-search": "",
              ...
              return [
                createVNode("div", { class: "space-y-6" }, [
                  createVNode("div", { class: "grid grid-cols-2 gap-5" }, [
                    ...
                    ((_b = unref(useSubscription).store.course_ids) == null ? void 0 : _b.length) ? (openBlock(), createBlock("ul", {
                      key: 0,
                    ...
                    createVNode("div", { class: "col-span-2 space-y-2" }, [
                      ...
                      createTextVNode(" " + toDisplayString(unref(useAuth).user.role) + " ", 1),
                      createVNode(_component_a_select, {
                        class: "w-full",
                        value: unref(useAuth).user.role,
                        "onUpdate:value": ($event) => unref(useAuth).user.role = $event,
...
const _sfc_main$e = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "overflow-hidden" }, _attrs))} data-v-e6eff5ce><nav class="flex items-center justify-between w-full mb-6" data-v-e6eff5ce><div class="flex items-center" data-v-e6eff5ce><div class="flex items-center justify-center cursor-pointer rounded-[4px] h-6 w-6 bg-[#EEEDF2] relative" data-v-e6eff5ce><img loading="lazy" class="rotate-90"${ssrRenderAttr("src", _imports_3$2)} alt="" data-v-e6eff5ce></div><p class="font-medium text-center text-2xl leading-7 w-[270px]" data-v-e6eff5ce>${ssrInterpolate(months[unref(store).month])} ${ssrInterpolate(unref(store).year)}</p><div class="flex items-center justify-center cursor-pointer rounded-[4px] h-6 w-6 bg-[#EEEDF2]" data-v-e6eff5ce><img loading="lazy" class="-rotate-90"${ssrRenderAttr("src", _imports_3$2)} alt="" data-v-e6eff5ce></div></div><div class="flex gap-3" data-v-e6eff5ce><div class="flex items-center bg-[#E6F2FF] h-[46px] w-[92px] rounded-[10px]" data-v-e6eff5ce><button class="${ssrRenderClass([unref(store).sliderShow == 1 ? "bg-[#027DFC]" : "", "flex items-center justify-center h-[46px] w-[46px] rounded-[10px]"])}" data-v-e6eff5ce><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-e6eff5ce><path d="M3 3H11.1V11.1H3V3ZM4.8 4.8V9.3H9.3V4.8H4.8ZM3 12.9H11.1V21H3V12.9ZM4.8 14.7V19.2H9.3V14.7H4.8ZM12.9 3H21V11.1H12.9V3ZM14.7 4.8V9.3H19.2V4.8H14.7ZM12.9 12.9H21V21H12.9V12.9ZM14.7 14.7V19.2H19.2V14.7H14.7Z"${ssrRenderAttr("fill", unref(store).sliderShow == 2 ? "#027DFC" : "#FFFFFF")} data-v-e6eff5ce></path></svg></button><button class="${ssrRenderClass([unref(store).sliderShow == 2 ? "bg-[#027DFC]" : "", "flex items-center justify-center h-[46px] w-[46px] rounded-[10px]"])}" data-v-e6eff5ce><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-e6eff5ce><path d="M21 9.6L21 5.6C21 5.17565 20.842 4.76869 20.5607 4.46863C20.2794 4.16857 19.8978 4 19.5 4L4.5 4C4.10217 4 3.72064 4.16857 3.43934 4.46863C3.15804 4.76869 3 5.17565 3 5.6L3 9.6C3 10.0243 3.15803 10.4313 3.43934 10.7314C3.72064 11.0314 4.10217 11.2 4.5 11.2L19.5 11.2C19.8978 11.2 20.2794 11.0314 20.5607 10.7314C20.842 10.4313 21 10.0243 21 9.6ZM4.6 9.6C4.54477 9.6 4.5 9.55523 4.5 9.5L4.5 5.7C4.5 5.64477 4.54477 5.6 4.6 5.6L19.4 5.6C19.4552 5.6 19.5 5.64477 19.5 5.7L19.5 9.5C19.5 9.55523 19.4552 9.6 19.4 9.6L4.6 9.6ZM21 18.4L21 14.4C21 13.9757 20.842 13.5687 20.5607 13.2686C20.2794 12.9686 19.8978 12.8 19.5 12.8L4.5 12.8C4.10217 12.8 3.72064 12.9686 3.43934 13.2686C3.15803 13.5687 3 13.9757 3 14.4L3 18.4C3 18.8243 3.15803 19.2313 3.43934 19.5314C3.72064 19.8314 4.10217 20 4.5 20L19.5 20C19.8978 20 20.2794 19.8314 20.5607 19.5314C20.842 19.2313 21 18.8243 21 18.4ZM4.6 18.4C4.54477 18.4 4.5 18.3552 4.5 18.3L4.5 14.5C4.5 14.4448 4.54477 14.4 4.6 14.4L19.4 14.4C19.4552 14.4 19.5 14.4448 19.5 14.5L19.5 18.3C19.5 18.3552 19.4552 18.4 19.4 18.4L4.6 18.4Z"${ssrRenderAttr("fill", unref(store).sliderShow == 1 ? "#027DFC" : "#FFFFFF")} data-v-e6eff5ce></path></svg></button></div><button class="h-[46px] px-[56px] rounded-[10px] text-sm leading-4 bg-[#027DFC] text-white" data-v-e6eff5ce> + Add event </button></div></nav><div id="mainSlider" class="flex" data-v-e6eff5ce><section class="min-w-full space-y-[6px] calendar" data-v-e6eff5ce><div class="grid grid-cols-7 gap-[6px] opacity-40" data-v-e6eff5ce><!--[-->`);
      ssrRenderList(weeks, (i) => {
        _push(`<p class="leading-[15px] text-end" data-v-e6eff5ce>${ssrInterpolate(i)}</p>`);
      });
      _push(`<!--]--></div><!--[-->`);
      ssrRenderList(unref(store).calendar, (i) => {
        _push(`<div class="grid grid-cols-7 gap-[6px]" data-v-e6eff5ce><!--[-->`);
        ssrRenderList(i, (date, dateIndex) => {
          ...
          }, "flex justify-between cursor-pointer p-[10px] rounded-lg h-[113px]"])}" data-v-e6eff5ce><div class="grid grid-cols-2 gap-[10px] max-h-[113px] overflow-hidden overflow-y-auto" data-v-e6eff5ce><!--[-->`);
          ssrRenderList(+date[1], (i2, index) => {
            _push(`<div class="${ssrRenderClass([index % 2 != 0 ? "ml-[15px]" : "", "flex items-center justify-center bg-[#FF4D4D1A] h-6 w-6 rounded-full"])}" data-v-e6eff5ce>`);
            _push(ssrRenderComponent(_component_a_tooltip, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt="" data-v-e6eff5ce${_scopeId}>`);
                } else {
                  return [
                    createVNode("img", {
                      loading: "lazy",
          ...
          _push(`<!--]--></div><p class="${ssrRenderClass([date[0] != unref(store).month ? "opacity-20" : "", "font-medium leading-[19px]"])}" data-v-e6eff5ce>${ssrInterpolate(date[1])}</p></div>`);
        });
        _push(`<!--]--></div>`);
      });
      _push(`<!--]--><div class="flex gap-10 items-center pt-6" data-v-e6eff5ce><div class="flex gap-[8px] items-center" data-v-e6eff5ce><div class="flex justify-center items-center bg-[#FDF8E9] h-6 w-6 rounded-full" data-v-e6eff5ce><img loading="lazy" class="h-4 w-4"${ssrRenderAttr("src", _imports_2$1)} alt="" data-v-e6eff5ce></div><p class="text-sm leading-[15px] font-medium" data-v-e6eff5ce>Appointment</p></div><div class="flex gap-[8px] items-center" data-v-e6eff5ce><div class="flex justify-center items-center bg-[#027DFC1A] h-6 w-6 rounded-full" data-v-e6eff5ce><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-e6eff5ce></div><p class="text-sm leading-[15px] font-medium" data-v-e6eff5ce>Event</p></div><div class="flex gap-[8px] items-center" data-v-e6eff5ce><div class="flex justify-center items-center bg-[#FF4D4D1A] h-6 w-6 rounded-full" data-v-e6eff5ce><img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt="" data-v-e6eff5ce></div><p class="text-sm leading-[15px] font-medium" data-v-e6eff5ce>Case deadline</p></div><div class="flex gap-[8px] items-center" data-v-e6eff5ce><div class="flex justify-center items-center bg-[#13C1B71A] h-6 w-6 rounded-full" data-v-e6eff5ce><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-e6eff5ce></div><p class="text-sm leading-[15px] font-medium" data-v-e6eff5ce>Birthday</p></div></div></section><section class="flex gap-[26px] min-w-full" data-v-e6eff5ce><div class="min-w-[316px] space-y-4" data-v-e6eff5ce><div class="grid grid-rows-6 py-[27px] rounded-lg bg-[#F4F3F9] px-6 w-full h-[250px]" data-v-e6eff5ce><div class="grid grid-cols-7 row-span-1 text-center" data-v-e6eff5ce><!--[-->`);
      ssrRenderList(weeks, (i) => {
        _push(`<p class="text-[10px] leading-4 text-[#71717A]" data-v-e6eff5ce>${ssrInterpolate(i)}</p>`);
      });
      _push(`<!--]--></div><div class="grid grid-cols-7 font-medium row-span-5 text-center" data-v-e6eff5ce><!--[-->`);
      ssrRenderList(unref(store).days, (i) => {
        _push(`<div class="${ssrRenderClass([i == 15 ? "bg-[#11253B] text-white" : "", "flex flex-col items-center justify-center hover:bg-[#11253B] hover:text-white cursor-pointer duration-500 text-[11px] w-7 h-7 mx-auto rounded-lg"])}" data-v-e6eff5ce><p class="leading-4" data-v-e6eff5ce>${ssrInterpolate(i)}</p><p class="flex gap-[2px] justify-center" data-v-e6eff5ce><span class="h-1 w-1 inline-block bg-[#EEB627] rounded-full" data-v-e6eff5ce></span><span class="h-1 w-1 inline-block bg-[#13C1B7] rounded-full" data-v-e6eff5ce></span><span class="h-1 w-1 inline-block bg-[#FF0000] rounded-full" data-v-e6eff5ce></span></p></div>`);
      });
      _push(`<!--]--></div></div><div class="bg-[#F4F3F9] rounded-lg px-5 py-8" data-v-e6eff5ce><h1 class="text-[11px] font-bold leading-[11px] uppercase mb-4" data-v-e6eff5ce> Show calendar by </h1><div class="flex items-center gap-4" data-v-e6eff5ce><button class="flex items-center justify-center border border-[#027DFC] rounded-2xl h-8 px-[14px]" data-v-e6eff5ce> Day </button><button class="flex items-center justify-center border border-[#027DFC] bg-[#027DFC] text-white rounded-2xl h-8 px-[14px]" data-v-e6eff5ce> Week </button><button class="flex items-center justify-center border border-[#027DFC] rounded-2xl h-8 px-[14px]" data-v-e6eff5ce> Month </button></div></div><div class="grid grid-cols-2 px-5 py-6 gap-5 bg-[#F4F3F9] rounded-lg" data-v-e6eff5ce><div class="flex gap-[8px] items-center" data-v-e6eff5ce><div class="flex justify-center items-center bg-[#FDF8E9] h-6 w-6 rounded-full" data-v-e6eff5ce><img loading="lazy" class="h-4 w-4"${ssrRenderAttr("src", _imports_2$1)} alt="" data-v-e6eff5ce></div><p class="text-sm leading-[15px] font-medium" data-v-e6eff5ce>Appointment</p></div><div class="flex gap-[8px] items-center" data-v-e6eff5ce><div class="flex justify-center items-center bg-[#027DFC1A] h-6 w-6 rounded-full" data-v-e6eff5ce><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-e6eff5ce></div><p class="text-sm leading-[15px] font-medium" data-v-e6eff5ce>Event</p></div><div class="flex gap-[8px] items-center" data-v-e6eff5ce><div class="flex justify-center items-center bg-[#FF4D4D1A] h-6 w-6 rounded-full" data-v-e6eff5ce><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-e6eff5ce></div><p class="text-sm leading-[15px] font-medium" data-v-e6eff5ce>Case deadline</p></div><div class="flex gap-[8px] items-center" data-v-e6eff5ce><div class="flex justify-center items-center bg-[#13C1B71A] h-6 w-6 rounded-full" data-v-e6eff5ce><img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt="" data-v-e6eff5ce></div><p class="text-sm leading-[15px] font-medium" data-v-e6eff5ce>Birthday</p></div></div></div><div class="flex gap-3 w-full max-w-calc" data-v-e6eff5ce><ul class="space-y-[50px] text-[#999999] text-sm font-medium leading-6 mt-[77px]" data-v-e6eff5ce><!--[-->`);
      ssrRenderList(12, (i) => {
        _push(`<li data-v-e6eff5ce>${ssrInterpolate(i + 6)}:00</li>`);
      });
      _push(`<!--]--></ul><div class="flex gap-[14px] overflow-hidden overflow-x-auto min-w-full max-w-[calc(100vh_-_490px)]" data-v-e6eff5ce><!--[-->`);
      ssrRenderList(7, (i) => {
        _push(`<div class="bg-[#F4F3F9] font-medium rounded-lg py-[10px] w-[200px] h-full" data-v-e6eff5ce><h1 class="text-sm leading-[15px] px-[10px] opacity-40" data-v-e6eff5ce>Mon</h1><p class="text-2xl leading-7 px-[10px] mt-1 mb-[22px]" data-v-e6eff5ce>${ssrInterpolate(i + 6)}</p><div class="flex gap-3 py-[6px] bg-[#DEEEF2] h-[75px]" data-v-e6eff5ce><p class="min-w-[5px] bg-[#13C1B7] -my-[6px] min-h-full" data-v-e6eff5ce></p><div data-v-e6eff5ce><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="" data-v-e6eff5ce><p class="text-xs mt-2 leading-[14px] whitespace-nowrap truncate w-[85%] font-medium" data-v-e6eff5ce> Jack Johnson birthday text text text </p></div></div><div class="flex gap-3 py-[6px] bg-[#F5DBE0] h-[75px]" data-v-e6eff5ce><p class="min-w-[5px] bg-[#FF4C4C] -my-[6px] min-h-full" data-v-e6eff5ce></p><div data-v-e6eff5ce><img loading="lazy"${ssrRenderAttr("src", _imports_1)} alt="" data-v-e6eff5ce><p class="text-xs mt-2 leading-[14px] whitespace-nowrap truncate w-[85%] font-medium" data-v-e6eff5ce> This is a name of the case </p><p class="text-[#027DFC] mt-[6px] text-sm leading-[14px] font-medium" data-v-e6eff5ce> #00253 </p></div></div></div>`);
      });
      ...
      _push(ssrRenderComponent(_component_a_modal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<form class="space-y-5" data-v-e6eff5ce${_scopeId}><h1 class="text-2xl pb-2 font-semibold _c07" data-v-e6eff5ce${_scopeId}>`);
            if (_ctx.$t("nav.uz") != "uz") {
              _push2(`<span data-v-e6eff5ce${_scopeId}>`);
              if (unref(store).editEventModal) {
                _push2(`<span data-v-e6eff5ce${_scopeId}>${ssrInterpolate(_ctx.$t("edit"))}</span>`);
              } else {
                _push2(`<span data-v-e6eff5ce${_scopeId}>${ssrInterpolate(_ctx.$t("add"))}</span>`);
              }
              _push2(`</span>`);
            } else {
              _push2(`<!---->`);
            ...
            if (_ctx.$t("nav.uz") == "uz") {
              _push2(`<span class="lowercase" data-v-e6eff5ce${_scopeId}>`);
              if (unref(store).editEventModal) {
                _push2(`<span data-v-e6eff5ce${_scopeId}>${ssrInterpolate(_ctx.$t("edit"))}</span>`);
              } else {
                _push2(`<span data-v-e6eff5ce${_scopeId}>${ssrInterpolate(_ctx.$t("add"))}</span>`);
            ...
            _push2(`</h1><div data-v-e6eff5ce${_scopeId}>`);
            ...
            _push2(`<p class="text-end mt-1 _ca1 text-sm" data-v-e6eff5ce${_scopeId}></p></div><div class="grid md:grid-cols-5 grid-cols-2 flex-wrap items-center gap-2" data-v-e6eff5ce${_scopeId}><div class="flex items-center !min-w-full" data-v-e6eff5ce${_scopeId}>`);
            _push2(ssrRenderComponent(_component_a_date_picker, {
              ...
              suffixIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img class="w-4"${ssrRenderAttr("src", _imports_3$2)} alt="" data-v-e6eff5ce${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      class: "w-4",
            ...
            _push2(`</div><div class="w-full" data-v-e6eff5ce${_scopeId}>`);
            _push2(ssrRenderComponent(_component_a_select, {
              class: "w-full",
              onChange: _ctx.checkIsActive,
                ...
                if (_push3) {
                  ...
                  ssrRenderList(time_list, (item2) => {
                    _push3(ssrRenderComponent(_component_a_option, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex items-center gap-2" data-v-e6eff5ce${_scopeId3}>${ssrInterpolate(item2)} `);
                          if (unref(create).time == item2) {
                            _push4(`<img${ssrRenderAttr("src", _imports_3$3)} alt="" data-v-e6eff5ce${_scopeId3}>`);
                          } else {
                            _push4(`<!---->`);
                          }
                          _push4(`</div>`);
            ...
            _push2(`</div><div class="w-full md:col-span-1 col-span-2" data-v-e6eff5ce${_scopeId}>`);
            _push2(ssrRenderComponent(_component_a_select, {
              class: "w-full",
              onChange: _ctx.checkIsActive,
                ...
                if (_push3) {
                  ...
                  ssrRenderList(48, (item2) => {
                    _push3(ssrRenderComponent(_component_a_option, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex items-center gap-2" data-v-e6eff5ce${_scopeId3}>${ssrInterpolate(item2 / 2)} ${ssrInterpolate(item2 / 2 == 1 ? "hour" : "hours")} `);
            ...
            _push2(`</div><div class="w-full col-span-2 timezone" data-v-e6eff5ce${_scopeId}>`);
            _push2(ssrRenderComponent(_component_a_select, {
            ...
            if (unref(store).recurring) {
              _push2(`<div data-v-e6eff5ce${_scopeId}><div class="flex items-center gap-5" data-v-e6eff5ce${_scopeId}><p data-v-e6eff5ce${_scopeId}>Repeat every</p>`);
              _push2(ssrRenderComponent(_component_a_select, {
                  ...
                  if (_push3) {
                    ...
                    ssrRenderList(Object.keys(repeat_data), (item2) => {
                      _push3(ssrRenderComponent(_component_a_option, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="flex items-center gap-2 capitalize" data-v-e6eff5ce${_scopeId3}>${ssrInterpolate(item2)} `);
                            if (unref(create).timezone == item2) {
                              _push4(`<img${ssrRenderAttr("src", _imports_3$3)} alt="" data-v-e6eff5ce${_scopeId3}>`);
                            } else {
                              _push4(`<!---->`);
              ...
              if (unref(create).repeat == "month" || unref(create).repeat == "week") {
                _push2(`<div class="mt-6" data-v-e6eff5ce${_scopeId}><p data-v-e6eff5ce${_scopeId}>Repeat on</p><div class="flex items-center gap-0" data-v-e6eff5ce${_scopeId}><!--[-->`);
              ...
              _push2(`<div class="mt-6" data-v-e6eff5ce${_scopeId}><p data-v-e6eff5ce${_scopeId}>End</p><div class="!space-y-6 mt-4" data-v-e6eff5ce${_scopeId}><label for="never" class="flex items-center gap-4" data-v-e6eff5ce${_scopeId}><input class="w-5" type="radio" name="end" id="never" data-v-e6eff5ce${_scopeId}><p data-v-e6eff5ce${_scopeId}>Never</p></label><label for="on" class="flex items-center gap-4" data-v-e6eff5ce${_scopeId}><input class="w-5" type="radio" name="end" id="on" data-v-e6eff5ce${_scopeId}><p class="flex items-center" data-v-e6eff5ce${_scopeId}><span class="block min-w-[60px]" data-v-e6eff5ce${_scopeId}>On</span>`);
              _push2(ssrRenderComponent(_component_a_date_picker, {
                onChange: _ctx.checkIsActive,
                modelValue: unref(create).date,
                "onUpdate:modelValue": ($event) => unref(create).date = $event,
              ...
              _push2(`</p></label><label for="after" class="flex items-center gap-4" data-v-e6eff5ce${_scopeId}><input class="w-5" type="radio" name="end" id="after" data-v-e6eff5ce${_scopeId}><p class="flex items-center" data-v-e6eff5ce${_scopeId}><span class="block min-w-[60px]" data-v-e6eff5ce${_scopeId}>After</span><input type="number" class="w-20" data-v-e6eff5ce${_scopeId}><span class="block ml-2" data-v-e6eff5ce${_scopeId}>occurrences</span></p></label></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="flex md:flex-row flex-col md:items-center gap-4" data-v-e6eff5ce${_scopeId}><div data-v-e6eff5ce${_scopeId}><label class="_ca1 block mb-2 text-xs" for="location" data-v-e6eff5ce${_scopeId}>Location</label>`);
            _push2(ssrRenderComponent(_component_a_dropdown, { class: "dropdown !h-[50px] b_ccc rounded-xl px-3 !w-full" }, {
                        ...
                        ssrRenderList(location_list, (item2) => {
                          _push4(ssrRenderComponent(_component_a_menu_item, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="flex items-center !gap-2" data-v-e6eff5ce${_scopeId4}><img${ssrRenderAttr("src", item2.value)} alt="" data-v-e6eff5ce${_scopeId4}><p data-v-e6eff5ce${_scopeId4}>${ssrInterpolate(item2.label)}</p></div>`);
                              } else {
                                return [
                                  createVNode("div", { class: "flex items-center !gap-2" }, [
                                    createVNode("img", {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2, _c2, _d2;
                if (_push3) {
                  _push3(`<div class="flex items-center justify-between w-full min-w-[132px]" data-v-e6eff5ce${_scopeId2}><div class="flex items-center !md:w-[132px] !w-full gap-2" data-v-e6eff5ce${_scopeId2}><img${ssrRenderAttr("src", (_a2 = unref(create).location) == null ? void 0 : _a2.value)} alt="" data-v-e6eff5ce${_scopeId2}> ${ssrInterpolate((_b2 = unref(create).location) == null ? void 0 : _b2.label)}</div><img${ssrRenderAttr("src", _imports_3$2)} alt="" data-v-e6eff5ce${_scopeId2}></div>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="w-full" data-v-e6eff5ce${_scopeId}><label class="_ca1 block mb-2 text-xs" for="location" data-v-e6eff5ce${_scopeId}>${ssrInterpolate(((_a = unref(create).location) == null ? void 0 : _a.label) != "Link" ? ((_b = unref(create).location) == null ? void 0 : _b.label) + " link" : (_c = unref(create).location) == null ? void 0 : _c.label)}</label><input${ssrRenderAttr("value", unref(create).location_value)} type="text" class="!font-[400]"${ssrRenderAttr("placeholder", _ctx.$t("calendar.enterurl"))} data-v-e6eff5ce${_scopeId}></div></div><div data-v-e6eff5ce${_scopeId}><textarea id="write_message" class="h-[90px] text-sm w-full rounded-[4px]"${ssrRenderAttr("placeholder", _ctx.$t("description"))} data-v-e6eff5ce${_scopeId}>${ssrInterpolate(unref(create).description)}</textarea><p class="text-end mt-2 _ca1 text-sm" data-v-e6eff5ce${_scopeId}>${ssrInterpolate((_d = unref(create).description) == null ? void 0 : _d.length)}/300 </p></div><div class="sm:flex gap-4 sm:w-full w-[366px] max-w-full" data-v-e6eff5ce${_scopeId}><div data-v-e6eff5ce${_scopeId}>`);
            if (!((_e = unref(isLoading).store) == null ? void 0 : _e.croppedImage)) {
              _push2(`<label for="add_photo_event" class="full_flex flex-col gap-1 cursor-pointer _c2a bg_cf2 rounded-xl font-medium text-sm sm:h-[188px] h-[164px] w-[366px] max-w-full" data-v-e6eff5ce${_scopeId}><img${ssrRenderAttr("src", _imports_5)} alt="" data-v-e6eff5ce${_scopeId}><p class="c_main" data-v-e6eff5ce${_scopeId}>Upload cover image</p><p class="c_ca1 text-xs font-medium" data-v-e6eff5ce${_scopeId}>1460 x 752 px</p></label>`);
            } else {
              _push2(`<label class="relative imagelabel" for="add_photo_event" data-v-e6eff5ce${_scopeId}><button type="button" class="absolute deleteimage !hidden top-2 right-2 rounded-full w-7 h-7 full_flex border p-2" data-v-e6eff5ce${_scopeId}><img${ssrRenderAttr("src", _imports_1$2)} alt="" data-v-e6eff5ce${_scopeId}></button><img class="sm:h-[188px] h-[164px] w-[366px] max-w-full overflow-hidden rounded-xl object-cover"${ssrRenderAttr("src", unref(isLoading).store.croppedImage)} alt="" data-v-e6eff5ce${_scopeId}></label>`);
            }
            _push2(`</div><div class="py-5 space-y-5 w-full" data-v-e6eff5ce${_scopeId}><div class="w-full" data-v-e6eff5ce${_scopeId}><label class="_ca1 text-xs" for="access" data-v-e6eff5ce${_scopeId}>Who can attend this event</label>`);
            _push2(ssrRenderComponent(_component_a_select, {
                ...
                if (_push3) {
                  ...
                  ssrRenderList(access_list, (item2) => {
                    _push3(ssrRenderComponent(_component_a_option, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex items-center gap-2" data-v-e6eff5ce${_scopeId3}>${ssrInterpolate(_ctx.$t(`calendar.${item2.label}`))} `);
            ...
            if (unref(create).access == "level") {
              _push2(`<div data-v-e6eff5ce${_scopeId}><label class="_ca1 text-xs" for="access" data-v-e6eff5ce${_scopeId}>${ssrInterpolate(_ctx.$t("calendar.levelstart"))}</label>`);
              _push2(ssrRenderComponent(_component_a_select, {
            ...
            _push2(`</div><div class="file_input" data-v-e6eff5ce${_scopeId}><input id="add_photo_event" type="file" accept="image/*" data-v-e6eff5ce${_scopeId}></div></div><div class="flex items-center justify-between sm:pt-3 !sm:mt-8 !mt-5 text-sm font-semibold whitespace-nowrap" data-v-e6eff5ce${_scopeId}>`);
            if (unref(store).editEventModal) {
              _push2(`<button${ssrRenderAttrs(mergeProps({
                type: "button",
                class: "uppercase h-10 px-6 rounded-lg _ceb"
              }, ssrGetDirectiveProps(_ctx, _directive_loading, unref(isLoading).isLoadingType("deleteEvent"))))} data-v-e6eff5ce${_scopeId}>${ssrInterpolate(_ctx.$t("calendar.delete"))}</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="flex justify-end w-full gap-3" data-v-e6eff5ce${_scopeId}><button type="button" class="uppercase h-10 px-6 rounded-lg _ca1" data-v-e6eff5ce${_scopeId}>${ssrInterpolate(_ctx.$t("cancel"))}</button><button${ssrRenderAttrs(mergeProps({
            ...
            }, ssrGetDirectiveProps(_ctx, _directive_loading, unref(isLoading).isLoadingType("addEvents"))))} data-v-e6eff5ce${_scopeId}>`);
            if (unref(store).editEventModal) {
              _push2(`<span data-v-e6eff5ce${_scopeId}>${ssrInterpolate(_ctx.$t("save"))}</span>`);
            } else {
              _push2(`<span data-v-e6eff5ce${_scopeId}>${ssrInterpolate(_ctx.$t("add"))}</span>`);
            }
...
const __nuxt_component_6$1 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-e6eff5ce"]]);
const _sfc_main$d = {};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender]]);
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(_attrs)} data-v-c62e93ae><section data-v-c62e93ae><main id="main-content" class="mx-auto px-4 sm:px-6 lg:px-8 py-8" data-v-c62e93ae><div id="page-header" class="mb-8" data-v-c62e93ae><div class="flex items-center justify-between" data-v-c62e93ae><div data-v-c62e93ae><h1 class="text-3xl font-bold text-gray-900" data-v-c62e93ae>Payment History</h1><p class="mt-2 text-gray-600" data-v-c62e93ae>Track all your course purchases and payment details</p></div>`);
      if ((_b = (_a = unref(useStripe).store.userGrouppaymentHistory) == null ? void 0 : _a.payment) == null ? void 0 : _b.length) {
        _push(`<div class="flex items-center space-x-3" data-v-c62e93ae><button class="bg-white border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center" data-v-c62e93ae><i class="mr-2 w-5" data-fa-i2svg="" data-v-c62e93ae><svg class="svg-inline--fa fa-download" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="download" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" data-v-c62e93ae><path fill="currentColor" d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32V274.7l-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7V32zM64 352c-35.3 0-64 28.7-64 64v32c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V416c0-35.3-28.7-64-64-64H346.5l-45.3 45.3c-25 25-65.5 25-90.5 0L165.5 352H64zm368 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48z" data-v-c62e93ae></path></svg></i> Export </button><button class="bg-primary text-white rounded-lg px-4 py-2 text-sm font-medium bg-blue-600 flex items-center" data-v-c62e93ae><i class="mr-2 w-5" data-fa-i2svg="" data-v-c62e93ae><svg class="svg-inline--fa fa-filter" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="filter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" data-v-c62e93ae><path fill="currentColor" d="M3.9 54.9C10.5 40.9 24.5 32 40 32H472c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9V448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6V320.9L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" data-v-c62e93ae></path></svg></i> Filter </button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
      if (!((_d = (_c = unref(useStripe).store.userGrouppaymentHistory) == null ? void 0 : _c.payment) == null ? void 0 : _d.length)) {
        _push(`<div class="full_flex flex-col gap-4 _c07 h-[180px] r_8" data-v-c62e93ae><img${ssrRenderAttr("src", _imports_0$3)} alt="" data-v-c62e93ae> ${ssrInterpolate(_ctx.$t("You have no payments."))}</div>`);
      } else {
        _push(`<section data-v-c62e93ae><div id="stats-overview" class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8" data-v-c62e93ae><div class="bg-white rounded-xl p-6 shadow-sm border" data-v-c62e93ae><div class="flex items-center" data-v-c62e93ae><div class="p-3 bg-green-100 rounded-lg" data-v-c62e93ae><img class="w-5"${ssrRenderAttr("src", _imports_1$3)} alt="" data-v-c62e93ae></div><div class="ml-4" data-v-c62e93ae><p class="text-sm font-medium text-gray-600" data-v-c62e93ae>Total Spent</p><p class="text-2xl font-bold text-gray-900" data-v-c62e93ae>$${ssrInterpolate((_f = (_e = unref(useStripe).store.userGrouppaymentHistory) == null ? void 0 : _e.total) == null ? void 0 : _f.total_payment)}</p></div></div></div><div class="bg-white rounded-xl p-6 shadow-sm border" data-v-c62e93ae><div class="flex items-center" data-v-c62e93ae><div class="p-3 bg-blue-100 rounded-lg" data-v-c62e93ae><img class="w-5"${ssrRenderAttr("src", _imports_2$2)} alt="" data-v-c62e93ae></div><div class="ml-4" data-v-c62e93ae><p class="text-sm font-medium text-gray-600" data-v-c62e93ae>Courses Purchased</p><p class="text-2xl font-bold text-gray-900" data-v-c62e93ae>${ssrInterpolate((_h = (_g = unref(useStripe).store.userGrouppaymentHistory) == null ? void 0 : _g.total) == null ? void 0 : _h.purchased_courses_count)}</p></div></div></div><div class="bg-white rounded-xl p-6 shadow-sm border" data-v-c62e93ae><div class="flex items-center" data-v-c62e93ae><div class="p-3 bg-purple-100 rounded-lg" data-v-c62e93ae><img class="w-5"${ssrRenderAttr("src", _imports_3$4)} alt="" data-v-c62e93ae></div><div class="ml-4" data-v-c62e93ae><p class="text-sm font-medium text-gray-600" data-v-c62e93ae>This Month</p><p class="text-2xl font-bold text-gray-900" data-v-c62e93ae>$${ssrInterpolate((_j = (_i = unref(useStripe).store.userGrouppaymentHistory) == null ? void 0 : _i.total) == null ? void 0 : _j.total_monthly_payment)}</p></div></div></div><div class="bg-white rounded-xl p-6 shadow-sm border" data-v-c62e93ae><div class="flex items-center" data-v-c62e93ae><div class="p-3 bg-orange-100 rounded-lg" data-v-c62e93ae><img class="w-5"${ssrRenderAttr("src", _imports_4$1)} alt="" data-v-c62e93ae></div><div class="ml-4" data-v-c62e93ae><p class="text-sm font-medium text-gray-600" data-v-c62e93ae>Avg Rating</p><p class="text-2xl font-bold text-gray-900" data-v-c62e93ae>4.8</p></div></div></div></div><div id="payment-table-section" class="bg-white rounded-xl shadow-sm border" data-v-c62e93ae><div class="px-6 py-4 border-b border-gray-200" data-v-c62e93ae><div class="flex items-center justify-between" data-v-c62e93ae><h2 class="text-lg font-semibold text-gray-900" data-v-c62e93ae>Recent Transactions</h2><div class="flex items-center space-x-3" data-v-c62e93ae><div class="relative" data-v-c62e93ae><input type="text" placeholder="Search transactions..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-transparent" data-v-c62e93ae><i class="absolute left-3 top-3 text-gray-400 text-sm" data-fa-i2svg="" data-v-c62e93ae><svg class="svg-inline--fa fa-magnifying-glass" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="magnifying-glass" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" data-v-c62e93ae><path fill="currentColor" d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" data-v-c62e93ae></path></svg></i></div></div></div></div><div id="payment-table" class="overflow-x-auto" data-v-c62e93ae><table class="w-full" data-v-c62e93ae><thead class="bg-gray-50" data-v-c62e93ae><tr data-v-c62e93ae><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c62e93ae> Course</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c62e93ae> Date</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c62e93ae> Amount</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c62e93ae> Status</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c62e93ae> Method</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c62e93ae> Actions</th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-c62e93ae><!--[-->`);
        ssrRenderList((_k = unref(useStripe).store.userGrouppaymentHistory) == null ? void 0 : _k.payment, (history) => {
          var _a2, _b2;
          _push(`<tr class="hover:bg-gray-50" data-v-c62e93ae><td class="px-6 py-4 whitespace-nowrap" data-v-c62e93ae><div class="flex items-center" data-v-c62e93ae><div class="h-10 w-10 rounded-lg flex items-center justify-center" data-v-c62e93ae><img class="r_8"${ssrRenderAttr("src", (_a2 = history.course) == null ? void 0 : _a2.cover)} alt="" data-v-c62e93ae></div><div class="ml-4" data-v-c62e93ae><div class="text-sm font-medium text-gray-900" data-v-c62e93ae>${ssrInterpolate((_b2 = history.course) == null ? void 0 : _b2.title)}</div><div class="text-sm text-gray-500" data-v-c62e93ae>Web Development</div></div></div></td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" data-v-c62e93ae>${ssrInterpolate(("formatDate" in _ctx ? _ctx.formatDate : unref(formatDate))(history.createdAt))}</td><td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900" data-v-c62e93ae> $${ssrInterpolate(history.amount)}</td><td class="px-6 py-4 whitespace-nowrap" data-v-c62e93ae><span class="${ssrRenderClass([history.status == "completed" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-80", "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize"])}" data-v-c62e93ae>${ssrInterpolate(history.status)}</span></td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" data-v-c62e93ae><div class="flex items-center" data-v-c62e93ae><i class="text-blue-600 mr-2" data-fa-i2svg="" data-v-c62e93ae><svg class="svg-inline--fa fa-cc-visa" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="cc-visa" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="" data-v-c62e93ae><path fill="currentColor" d="M470.1 231.3s7.6 37.2 9.3 45H446c3.3-8.9 16-43.5 16-43.5-.2.3 3.3-9.1 5.3-14.9l2.8 13.4zM576 80v352c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V80c0-26.5 21.5-48 48-48h480c26.5 0 48 21.5 48 48zM152.5 331.2L215.7 176h-42.5l-39.3 106-4.3-21.5-14-71.4c-2.3-9.9-9.4-12.7-18.2-13.1H32.7l-.7 3.1c15.8 4 29.9 9.8 42.2 17.1l35.8 135h42.5zm94.4.2L272.1 176h-40.2l-25.1 155.4h40.1zm139.9-50.8c.2-17.7-10.6-31.2-33.7-42.3-14.1-7.1-22.7-11.9-22.7-19.2.2-6.6 7.3-13.4 23.1-13.4 13.1-.3 22.7 2.8 29.9 5.9l3.6 1.7 5.5-33.6c-7.9-3.1-20.5-6.6-36-6.6-39.7 0-67.6 21.2-67.8 51.4-.3 22.3 20 34.7 35.2 42.2 15.5 7.6 20.8 12.6 20.8 19.3-.2 10.4-12.6 15.2-24.1 15.2-16 0-24.6-2.5-37.7-8.3l-5.3-2.5-5.6 34.9c9.4 4.3 26.8 8.1 44.8 8.3 42.2.1 69.7-20.8 70-53zM528 331.4L495.6 176h-31.1c-9.6 0-16.9 2.8-21 12.9l-59.7 142.5H426s6.9-19.2 8.4-23.3H486c1.2 5.5 4.8 23.3 4.8 23.3H528z" data-v-c62e93ae></path></svg></i> \u2022\u2022\u2022\u2022 4242 </div></td><td class="px-6 py-4 whitespace-nowrap text-sm font-medium" data-v-c62e93ae><button class="text-primary hover:text-blue-600 mr-3" data-v-c62e93ae><i data-fa-i2svg="" data-v-c62e93ae><svg class="svg-inline--fa fa-download" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="download" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" data-v-c62e93ae><path fill="currentColor" d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32V274.7l-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7V32zM64 352c-35.3 0-64 28.7-64 64v32c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V416c0-35.3-28.7-64-64-64H346.5l-45.3 45.3c-25 25-65.5 25-90.5 0L165.5 352H64zm368 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48z" data-v-c62e93ae></path></svg></i></button><button class="text-gray-400 hover:text-gray-600" data-v-c62e93ae><i data-fa-i2svg="" data-v-c62e93ae><svg class="svg-inline--fa fa-ellipsis" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="" data-v-c62e93ae><path fill="currentColor" d="M8 256a56 56 0 1 1 112 0A56 56 0 1 1 8 256zm160 0a56 56 0 1 1 112 0 56 56 0 1 1 -112 0zm216-56a56 56 0 1 1 0 112 56 56 0 1 1 0-112z" data-v-c62e93ae></path></svg></i></button></td></tr>`);
        });
        _push(`<!--]--></tbody></table></div><div id="pagination" class="px-6 py-4 border-t border-gray-200" data-v-c62e93ae><div class="flex items-center justify-between" data-v-c62e93ae><div class="flex items-center text-sm text-gray-700 gap-1" data-v-c62e93ae> Showing <span class="font-medium" data-v-c62e93ae>1</span> to <span class="font-medium" data-v-c62e93ae>4</span> of <span class="font-medium" data-v-c62e93ae>12</span> results </div><div class="flex items-center space-x-2" data-v-c62e93ae><button class="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md hover:bg-gray-50" data-v-c62e93ae> Previous </button><button class="px-3 py-2 text-sm font-medium text-white bg-primary border border-primary rounded-md" data-v-c62e93ae> 1 </button><button class="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md hover:bg-gray-50" data-v-c62e93ae> 2 </button><button class="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md hover:bg-gray-50" data-v-c62e93ae> 3 </button><button class="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md hover:bg-gray-50" data-v-c62e93ae> Next </button></div></div></div></div><footer id="footer" class="bg-white border-t mt-12" data-v-c62e93ae><div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8" data-v-c62e93ae><div class="flex items-center justify-between" data-v-c62e93ae><div class="flex items-center" data-v-c62e93ae><h2 class="text-xl font-bold text-primary" data-v-c62e93ae>IlmNur</h2><p class="ml-4 text-sm text-gray-500" data-v-c62e93ae>\xA9 2025 All rights reserved.</p></div><div class="flex items-center space-x-6" data-v-c62e93ae><span class="text-gray-500 hover:text-primary text-sm cursor-pointer" data-v-c62e93ae>Privacy Policy</span><span class="text-gray-500 hover:text-primary text-sm cursor-pointer" data-v-c62e93ae>Terms of Service</span><span class="text-gray-500 hover:text-primary text-sm cursor-pointer" data-v-c62e93ae>Support</span></div></div></div></footer></section>`);
      }
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-c62e93ae"]]);
const _sfc_main$6 = {
  __name: "Analytics",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Analytics = _sfc_main$p;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_PageGroupSettingsPayouts = _sfc_main$c;
      const _component_PageGroupSettingsCourses = _sfc_main$b;
      const _component_PageGroupSettingsInvite = _sfc_main$a;
      const _component_PageGroupSettingsGeneral = _sfc_main$9;
      const _component_PageGroupSettingsSubscriptions = _sfc_main$8;
      const _component_PageGroupSettingsPayments = __nuxt_component_6;
      const _component_PageGroupSettingsAnalytics = _sfc_main$6;
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    function checkCurrentRole() {
      var _a, _b, _c;
      store.is_show = false;
      for (let user of (_a = useCourses.store.users) == null ? void 0 : _a.user) {
        if (isLoading.store.category_id == ((_b = user == null ? void 0 : user.subscriptions[0]) == null ? void 0 : _b.course_id) && ((_c = user == null ? void 0 : user.subscriptions[0]) == null ? void 0 : _c.role) == "teacher") {
          store.is_show = true;
          return true;
        }
      }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_a_menu_item = resolveComponent("a-menu-item");
      const _component_UIModal = _sfc_main$j;
      const _component_ChartLine = _sfc_main$4;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full" }, _attrs))}><nav class="w-full mb-2 space-y-2">`);
      _push(ssrRenderComponent(_component_CategorySlider, {
        category_id: ((_b = (_a = unref(useCourses).store.users) == null ? void 0 : _a.user) == null ? void 0 : _b.role) == "teacher" ? (_d = (_c = unref(useCourses).store.users) == null ? void 0 : _c.user) == null ? void 0 : _d.course_id : null,
        all: false,
        category: unref(useLessons).store.courses,
        class: "w-full"
      }, null, _parent));
      _push(`<div class="flex gap-3 min-w-fit"><div class="flex items-center bg_bg h-[46px] w-[46px] rounded-[10px]"><button class="flex items-center justify-center h-[46px] w-[46px] rounded-[10px]"><img loading="lazy"${ssrRenderAttr("src", _imports_0$6)} alt=""></button></div><button class="h-[46px] px-[56px] rounded-[10px] text-sm leading-4 bg_main text-white"> Show result </button></div></nav><section>`);
      _push(ssrRenderComponent(_component_a_date_picker, {
        value: unref(useSubscription).store.currentDate,
        "onUpdate:value": ($event) => unref(useSubscription).store.currentDate = $event,
        format: "DD/MM/YYYY",
        "disabled-date": disabledDate
      }, null, _parent));
      _push(`<div class="relative overflow-x-auto"><table class="w-full text-sm text-left rtl:text-right border-separate border-spacing-y-3"><tbody class="!space-y-5"><!--[-->`);
      ssrRenderList((_e = unref(useCourses).store.users) == null ? void 0 : _e.users, (i) => {
        var _a2, _b2, _c2, _d2;
        _push(`<tr class="bg_bg"><th scope="row" class="p-3 rounded-l-xl"><div class="flex items-center gap-5">`);
        _push(ssrRenderComponent(_component_UIAvatar, {
          class: "w-10 h-10 max-w-[40px] max-h-[40px]",
          src: (_a2 = i == null ? void 0 : i.user) == null ? void 0 : _a2.image
        }, null, _parent));
        _push(`<ul><li class="md:text-lg font-semibold">${ssrInterpolate((_b2 = i == null ? void 0 : i.user) == null ? void 0 : _b2.name)} ${ssrInterpolate((_c2 = i == null ? void 0 : i.user) == null ? void 0 : _c2.surname)}</li><li class="font-normal space-x-2"><span>${ssrInterpolate((_d2 = i == null ? void 0 : i.user) == null ? void 0 : _d2.current_role)}</span><span class="c_blue font-medium">5.0</span></li></ul></div></th><td class="px-6 rounded-r-xl">`);
        _push(ssrRenderComponent(_component_a_dropdown, { placement: "bottom" }, {
          overlay: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(store).is_show) {
                _push2(ssrRenderComponent(_component_a_menu, {
                  onClick: ({ key }) => handleStatus(key, i.id)
                }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<!--[-->`);
                      ssrRenderList(ball_options, (value, key) => {
                        _push3(ssrRenderComponent(_component_a_menu_item, {
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<button class="${ssrRenderClass([value[1], "text-white py-1 px-5 rounded-full w-full"])}"${_scopeId3}>${ssrInterpolate(value[0])}</button>`);
                            } else {
                              return [
                                createVNode("button", {
                                  class: ["text-white py-1 px-5 rounded-full w-full", value[1]]
                                }, toDisplayString(value[0]), 3)
                              ];
                            }
                          }),
                          _: 2
                      ...
                      return [
                        (openBlock(), createBlock(Fragment, null, renderList(ball_options, (value, key) => {
                          return createVNode(_component_a_menu_item, {
                            key,
                            class: "!p-1"
                          }, {
              ...
              return [
                unref(store).is_show ? (openBlock(), createBlock(_component_a_menu, {
                  key: 0,
                  onClick: ({ key }) => handleStatus(key, i.id)
                }, {
                  default: withCtx(() => [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a3, _b3, _c3, _d3;
            if (_push2) {
              _push2(`<button class="${ssrRenderClass([ball_options[((_a3 = i.subscriptionActivity) == null ? void 0 : _a3.status) || "none"], "text-white py-1 px-3 rounded-full capitalize"])}"${_scopeId}>${ssrInterpolate(ball_options[((_b3 = i.subscriptionActivity) == null ? void 0 : _b3.status) || "none"][0])}</button>`);
            } else {
              return [
                createVNode("button", {
                  onMousemove: checkCurrentRole,
                  class: ["text-white py-1 px-3 rounded-full capitalize", ball_options[((_c3 = i.subscriptionActivity) == null ? void 0 : _c3.status) || "none"]]
                }, toDisplayString(ball_options[((_d3 = i.subscriptionActivity) == null ? void 0 : _d3.status) || "none"][0]), 35)
              ];
            }
          }),
          _: 2
        ...
        _push(ssrRenderComponent(_component_UIModal, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`</div><p class="c_red"${_scopeId}>${ssrInterpolate(unref(isLoading).store.errorMessage.message)}</p></div><div class="grid grid-cols-3"${_scopeId}><button${_scopeId}>Members</button><button${_scopeId}>Members2</button><button${_scopeId}>Members3</button></div>`);
            } else {
              return [
                createVNode("div", { class: "space-y-6" }, [
                  createVNode("div", null, [
                ...
                createVNode("div", { class: "grid grid-cols-3" }, [
                  createVNode("button", {
                    onClick: ($event) => activeChartLine("Members")
                  }, "Members", 8, ["onClick"]),
                  createVNode("button", {
                    onClick: ($event) => activeChartLine("Members2")
                  }, "Members2", 8, ["onClick"]),
                  createVNode("button", {
                    onClick: ($event) => activeChartLine("Members3")
                  }, "Members3", 8, ["onClick"])
                ])
              ];
            }
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const PageGroupLessonsMain = _sfc_main$i;
    const PageGroupReytingMain = _sfc_main$n;
    const PageGroupChatMain = _sfc_main$h;
    const PageGroupNewsMain = _sfc_main$g;
    const PageGroupMembersMain = _sfc_main$f;
    const InfiniteScroll = _sfc_main$o;
    const PageGroupCalendarMain = __nuxt_component_6$1;
    const PageGroupSettingsMain = _sfc_main$5;
    const PageGroupActivityMain = _sfc_main$3;
...
//# sourceMappingURL=index-eWMM-GKw.mjs.map
