...
const _routes = [
  {
    name: "categories",
    path: "/categories",
    component: () => import('./index-CMddY5nO.mjs')
  },
  {
    name: "change-password",
    path: "/change-password",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./index-DKsfbbX8.mjs')
  },
  {
    name: "chat",
    path: "/chat",
    component: () => import('./index-D3rAfr9w.mjs')
  },
  {
    name: "course-course_id",
    path: "/course/:course_id()",
    component: () => import('./index-q_sfJZNH.mjs')
  },
  {
    name: "courses",
    path: "/courses",
    component: () => import('./index-C0D05OTA.mjs')
  },
  {
    name: "forgot-password",
    path: "/forgot-password",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./index-BeTlbks8.mjs')
  },
  {
    name: "group-group_id",
    path: "/group/:group_id()",
    component: () => import('./index-B9NaF_L9.mjs')
  },
  {
    name: "history",
    path: "/history",
    component: () => import('./index-Cga0kxrI.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CZ6v92Ze.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./index-B66DbulQ.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./index-NK9PX5jS.mjs')
  },
  {
    name: "my_groups-analytics",
    path: "/my_groups/analytics",
    component: () => import('./index-YpsuHD5v.mjs')
  },
  {
  ...
  },
  {
    name: "my_groups-earn",
    path: "/my_groups/earn",
    component: () => import('./index-N39D0Ez4.mjs')
  },
  {
    name: "my_groups-groups",
    path: "/my_groups/groups",
    component: () => import('./index-CUN_4RXA.mjs')
  },
  {
    name: "my_groups",
    path: "/my_groups",
    component: () => import('./index-DwFjeYM1.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-CHqbAMIz.mjs')
  },
  {
    name: "settings-account",
    path: "/settings/account",
    component: () => import('./index-b7RgBy7c.mjs')
  },
  {
    name: "settings-chat",
    path: "/settings/chat",
  ...
  },
  {
    ...
    component: () => import('./index-BQ-9Jhqh.mjs')
  },
  {
  ...
  },
  {
    name: "shorts",
    path: "/shorts",
    component: () => import('./index-DgxnU2FO.mjs')
  },
  {
    name: "subscriptions",
    path: "/subscriptions",
    component: () => import('./index-CM3OSpow.mjs')
  },
  {
    name: "test-test_id",
    path: "/test/:test_id()",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-CKHrxBTq.mjs')
  },
  {
  ...
  },
  {
    name: "users",
    path: "/users",
    component: () => import('./index-DSv-hiOh.mjs')
  },
  {
    name: "verify-email",
    path: "/verify-email",
  ...
  },
  {
    name: "video-chat",
    path: "/video-chat",
    component: () => import('./index-Dq3-rn4W.mjs')
  },
  {
    name: "webrtc",
    path: "/webrtc",
    component: () => import('./index-C8reDknb.mjs')
  }
];
  ...
  function post(url, data = {}, loadingType) {
    ...
    return new Promise(function(resolve, reject) {
      axios.post(url, data, { headers }).then((res) => {
        ...
        var _a, _b;
        openNotification("error", "Xatolik yuz berdi", getErrResponse((_b = (_a = err.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message));
        isLoading.removeLoading(loadingType);
        reject(err);
        if (err) {
...
const useAuthStore = defineStore("auth", () => {
  ...
  function getUserAnalytics(group_id, course_id) {
...
const useLessonsStore = defineStore("lessons", () => {
  ...
  async function getByCourse(group_id) {
    ...
    store.courses = (_b = (_a = data.data) == null ? void 0 : _a.courses) == null ? void 0 : _b.map((item) => {
      var _a2, _b2;
      return { ...item, attendance_days: ((_b2 = (_a2 = item == null ? void 0 : item.attendance_days) == null ? void 0 : _a2[0]) == null ? void 0 : _b2.attendance_day) || [] };
    });
    isLoading.store.owner_id = (_d = (_c = data.data) == null ? void 0 : _c.group) == null ? void 0 : _d.user_id;
  }
  ...
  async function updateLesson(is_redirect) {
...
const useCoursesStore = defineStore("courses", () => {
  ...
  async function createPayment(data) {
    const res = await apiRequest.post(`payment/create`, { ...data }, "payments");
    console.log(res);
    if (res.status == 201) {
      getByCourse();
    }
  ...
  async function getByCourse() {
    ...
    const date = ((_a = router.currentRoute.value.query) == null ? void 0 : _a.date) ? /* @__PURE__ */ new Date(+((_b = router.currentRoute.value.query) == null ? void 0 : _b.date)) : null;
    const data = await apiRequest.get(
  ...
  async function getUsersByGroupId(form) {
    const data = await apiRequest.get(
      `course/getUsersByGroupId/${router.currentRoute.value.params.group_id || (form == null ? void 0 : form.group_id)}?date=${useAttendance.store.currentDate}&course_id=${+router.currentRoute.value.params.course_id}&lesson_id=${(form == null ? void 0 : form.lesson_id) || router.currentRoute.value.params.lesson_id}&page=${router.currentRoute.value.query.page}`,
      "course"
    );
  ...
  async function updateCourse(group_id) {
...
const useSubscriptionStore = defineStore("subscription", () => {
  ...
  async function subscribeToGroup(course_id, user_id) {
    await apiRequest.post(
      "subscriptions/create",
      {
        role: "student",
  ...
  async function createSubscribeUser(data) {
    let course_ids = [];
  ...
  async function createTest() {
    ...
    if (test_settings.test_type == "pdf_file") {
      tests = tests.map((item) => {
        var _a2;
        return { ...item, question: (_a2 = tests[0]) == null ? void 0 : _a2.question };
      });
    }
...
const layouts = {
  default: () => import('./default-DYRzg5vu.mjs')
};
