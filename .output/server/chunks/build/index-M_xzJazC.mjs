...
import { _ as _sfc_main$3 } from './Modal-CNknc8lN.mjs';
import { _ as __nuxt_component_2 } from './FloatingInput-BXwGQfMP.mjs';
import { _ as _imports_2$1, a as _imports_0$1, b as _sfc_main$4 } from './time-DQ0ORrm0.mjs';
import { _ as _sfc_main$5 } from './DeleteModal-CRgYI_wN.mjs';
import { _ as _imports_0, a as _sfc_main$6 } from './back_route-DYkfboeQ.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isLoading).isLoadingType("getByCourse")) {
        ...
        _push(`<template><img${ssrRenderAttr("src", _imports_0$2)} alt=""><div>O&#39;qituvchi `);
        if (((_B = unref(isLoading).user) == null ? void 0 : _B.current_role) == "admin") {
          _push(`<span>qo&#39;shish</span>`);
        } else {
          _push(`<span>biriktirilmagan</span>`);
        }
        _push(`</div></template></button></div><div class="flex justify-between items-center"><div class="flex items-center gap-5"><h1 class="font-semibold text-[24px]">${ssrInterpolate((_D = (_C = unref(useCourses).store.courses) == null ? void 0 : _C.course) == null ? void 0 : _D.title)}</h1>`);
        if (!isOwner()) {
          _push(`<div>`);
      ...
      _push(ssrRenderComponent(_component_UIModal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="space-y-6 mt-8"${_scopeId}>`);
            if (((_a2 = unref(isLoading).user) == null ? void 0 : _a2.current_role) == "admin") {
              _push2(`<!--[-->`);
              if (unref(store).addMember) {
                ...
                _push2(ssrRenderComponent(_component_a_select, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    ...
                    if (_push3) {
                      _push3(`<!--[-->`);
                      ssrRenderList((_a3 = unref(useAuth).store.users) == null ? void 0 : _a3.records, (user) => {
                        _push3(ssrRenderComponent(_component_a_select_option, {
                          key: user,
                          value: user.id
                        }, {
                      ...
                      return [
                        (openBlock(true), createBlock(Fragment, null, renderList((_b3 = unref(useAuth).store.users) == null ? void 0 : _b3.records, (user) => {
                          return openBlock(), createBlock(_component_a_select_option, {
                            key: user,
                            value: user.id
                          }, {
                ...
                _push2(`<button class="h-[46px] px-[56px] rounded-[10px] text-sm leading-4 bg_main text-white"${_scopeId}> + </button></div>`);
              } else {
                _push2(`<button class="h-[46px] px-[56px] rounded-[10px] text-sm leading-4 bg_main text-white"${_scopeId}> + O&#39;quvchi qo&#39;shish </button>`);
              }
              _push2(`<!--]-->`);
            } else {
              _push2(`<!---->`);
            ...
            _push2(`<ul${_scopeId}><!--[-->`);
            ssrRenderList((_c2 = (_b2 = unref(useCourses).store.courses) == null ? void 0 : _b2.course) == null ? void 0 : _c2.subscriptions, ({ user }) => {
              ...
              _push2(`<span${_scopeId}>${ssrInterpolate(user == null ? void 0 : user.name)} ${ssrInterpolate(user == null ? void 0 : user.surname)}</span></li>`);
            });
            _push2(`<!--]--></ul></div>`);
          } else {
            return [
              createVNode("div", { class: "space-y-6 mt-8" }, [
                ((_d2 = unref(isLoading).user) == null ? void 0 : _d2.current_role) == "admin" ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                  unref(store).addMember ? (openBlock(), createBlock("div", {
                    key: 0,
                    ...
                    createVNode(_component_a_select, {
                      ...
                      default: withCtx(() => {
                        var _a3;
                        return [
                          (openBlock(true), createBlock(Fragment, null, renderList((_a3 = unref(useAuth).store.users) == null ? void 0 : _a3.records, (user) => {
                            return openBlock(), createBlock(_component_a_select_option, {
                              key: user,
                              value: user.id
                            }, {
                ...
                createVNode("ul", null, [
                  (openBlock(true), createBlock(Fragment, null, renderList((_f2 = (_e2 = unref(useCourses).store.courses) == null ? void 0 : _e2.course) == null ? void 0 : _f2.subscriptions, ({ user }) => {
                    return openBlock(), createBlock("li", {
                      key: user.id,
                      class: "flex items-center gap-2"
                    }, [
                      ...
                      createVNode("span", null, toDisplayString(user == null ? void 0 : user.name) + " " + toDisplayString(user == null ? void 0 : user.surname), 1)
                    ]);
                  }), 128))
                ])
              ])
...
//# sourceMappingURL=index-M_xzJazC.mjs.map
