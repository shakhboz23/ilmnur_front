<template>
    <li class="flex justify-between max-h-fit p-2 hover:bg-[#E2E2E2] r_8">
        <ul class="space-y-2 w-full max-w-[60%]">
            <li class="text-lg font-semibold truncate">Machine Learning Learning Learning LearningLearning
                Learning Learning Learning LearningLearning Learning</li>
            <li class="flex gap-1">
                <span>4.5</span>
