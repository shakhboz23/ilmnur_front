<template>
    <div class="w-full">
        ...
        <section class="space-y-4">
            ...
            <div v-if="router.currentRoute.value.query.course_id && useAttendance.store.currentDate && (!selectedCourseSubgroups.length || store.subgroup_id)" class="relative overflow-x-auto rounded-2xl">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <ul class="leading-tight">
                                        ...
                                        <li class="font-normal flex items-center gap-2 mt-1 text-xs text-gray-500">
                                            ...
                                            <span class="inline-flex items-center gap-1 c_gold font-medium">
