<template>
    <div @click="$router.push(`/lesson/${lessoncard.id}`)"
        ...
        <div class="p-3 space-y-2">
            <h1 class="font-bold">{{ lessoncard.title }}</h1>
            <pre class="whitespace-pre-line line-clamp-2" v-html="lessoncard.content"></pre>
